...
**5077 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,906 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1204 | 33,962,038 |
| Domain codes (`code`) | 882 | 17,832,401 |
| Verification harness (`verification`) | 297 | 12,108,153 |
...
| Other tracked files (`other`) | 465 | 13,745,217 |
