...
**3843 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 5,012,422 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 935 | 27,655,566 |
| Domain codes (`code`) | 670 | 15,319,449 |
| Verification harness (`verification`) | 40 | 9,411,036 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,365,897 |
| Governance policies (`policy`) | 19 | 151,707 |
| Root documents (`root-doc`) | 14 | 1,532,222 |
| Other tracked files (`other`) | 205 | 9,721,283 |
