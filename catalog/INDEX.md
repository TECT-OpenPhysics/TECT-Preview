...
**5057 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,765 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1198 | 33,878,852 |
| Domain codes (`code`) | 876 | 17,781,698 |
| Verification harness (`verification`) | 295 | 12,091,900 |
...
| Other tracked files (`other`) | 459 | 13,704,689 |
