...
**6680 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,109,938 |
| Working proof notes (on claim cards) (`proof-note`) | 938 | 107,214,114 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1687 | 94,878,535 |
| Domain codes (`code`) | 1371 | 23,232,689 |
| Verification harness (`verification`) | 469 | 14,139,615 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,050 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,757,545 |
| Other tracked files (`other`) | 912 | 18,434,134 |
