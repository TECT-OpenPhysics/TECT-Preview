...
**6493 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,105,490 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1636 | 74,112,710 |
| Domain codes (`code`) | 1320 | 22,369,501 |
| Verification harness (`verification`) | 448 | 13,834,880 |
...
| Other tracked files (`other`) | 859 | 17,881,179 |
