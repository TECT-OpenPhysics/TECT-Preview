...
**7232 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,122,331 |
| Working proof notes (on claim cards) (`proof-note`) | 982 | 107,283,574 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1847 | 172,204,431 |
| Domain codes (`code`) | 1531 | 25,573,985 |
| Verification harness (`verification`) | 520 | 14,999,727 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,942 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,881,618 |
| Other tracked files (`other`) | 1049 | 19,970,123 |
