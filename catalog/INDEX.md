...
**7346 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,124,798 |
| Working proof notes (on claim cards) (`proof-note`) | 989 | 107,294,804 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1883 | 181,239,956 |
| Domain codes (`code`) | 1567 | 25,989,496 |
| Verification harness (`verification`) | 529 | 15,172,194 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,568,052 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,910,111 |
| Other tracked files (`other`) | 1075 | 20,299,955 |
