...
**5657 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,082,442 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1371 | 42,599,590 |
| Domain codes (`code`) | 1053 | 19,382,498 |
| Verification harness (`verification`) | 362 | 12,759,532 |
...
| Other tracked files (`other`) | 642 | 15,328,255 |
