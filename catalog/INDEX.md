...
**7359 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,125,029 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1887 | 181,457,966 |
| Domain codes (`code`) | 1571 | 26,034,617 |
| Verification harness (`verification`) | 530 | 15,190,738 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,568,794 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,912,575 |
| Other tracked files (`other`) | 1078 | 20,334,332 |
