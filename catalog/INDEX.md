...
**6771 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,112,223 |
| Working proof notes (on claim cards) (`proof-note`) | 946 | 107,224,451 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1711 | 95,551,220 |
| Domain codes (`code`) | 1395 | 23,598,995 |
| Verification harness (`verification`) | 479 | 14,296,091 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,623 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,778,296 |
| Other tracked files (`other`) | 937 | 18,675,201 |
