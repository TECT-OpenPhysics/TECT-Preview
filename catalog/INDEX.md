...
**7669 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 16,002,223 |
...
| Root documents (`root-doc`) | 14 | 1,987,713 |
| Other tracked files (`other`) | 1176 | 21,805,575 |
