...
**6503 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,105,767 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1639 | 74,730,179 |
| Domain codes (`code`) | 1323 | 22,407,385 |
| Verification harness (`verification`) | 449 | 13,847,193 |
...
| Other tracked files (`other`) | 862 | 17,913,439 |
