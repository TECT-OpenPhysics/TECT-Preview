...
**5457 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,336 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1314 | 40,984,472 |
| Domain codes (`code`) | 996 | 18,810,028 |
| Verification harness (`verification`) | 339 | 12,473,495 |
...
| Other tracked files (`other`) | 579 | 14,689,712 |
