...
**5209 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,974 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1243 | 34,383,402 |
| Domain codes (`code`) | 921 | 18,167,853 |
| Verification harness (`verification`) | 312 | 12,227,325 |
...
| Other tracked files (`other`) | 504 | 14,040,935 |
