...
**8404 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,140,227 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2180 | 269,799,948 |
| Domain codes (`code`) | 1789 | 28,411,592 |
| Verification harness (`verification`) | 718 | 19,649,242 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,585,147 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,171,945 |
| Other tracked files (`other`) | 1394 | 26,630,704 |
