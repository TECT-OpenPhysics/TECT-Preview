...
**8392 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,140,171 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2179 | 269,790,556 |
| Domain codes (`code`) | 1789 | 28,411,592 |
| Verification harness (`verification`) | 716 | 19,544,973 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,585,036 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,164,846 |
| Other tracked files (`other`) | 1385 | 26,450,805 |
