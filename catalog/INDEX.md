...
**8608 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,141,729 |
| Working proof notes (on claim cards) (`proof-note`) | 992 | 107,365,720 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2230 | 274,367,018 |
| Domain codes (`code`) | 1795 | 28,466,894 |
| Verification harness (`verification`) | 780 | 20,856,454 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,597,418 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,215,691 |
| Other tracked files (`other`) | 1478 | 28,072,468 |
