...
**5497 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,017 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1326 | 41,275,709 |
| Domain codes (`code`) | 1008 | 18,928,784 |
| Verification harness (`verification`) | 343 | 12,523,164 |
...
| Other tracked files (`other`) | 591 | 14,811,211 |
