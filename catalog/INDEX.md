...
**4920 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,805,424 |
| Domain codes (`code`) | 840 | 17,501,058 |
| Verification harness (`verification`) | 281 | 11,936,894 |
...
| Other tracked files (`other`) | 414 | 13,328,448 |
