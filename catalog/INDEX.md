...
**5712 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,083,849 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1387 | 43,409,068 |
| Domain codes (`code`) | 1071 | 19,563,582 |
| Verification harness (`verification`) | 367 | 12,839,768 |
...
| Other tracked files (`other`) | 658 | 15,506,650 |
