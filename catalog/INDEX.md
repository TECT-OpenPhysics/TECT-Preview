...
**4877 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,410,117 |
| Domain codes (`code`) | 840 | 17,470,632 |
| Verification harness (`verification`) | 280 | 11,805,784 |
...
| Other tracked files (`other`) | 372 | 12,865,698 |
