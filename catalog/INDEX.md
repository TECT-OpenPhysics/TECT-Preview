...
**8400 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 718 | 19,605,025 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,585,085 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,170,672 |
| Other tracked files (`other`) | 1390 | 26,541,431 |
