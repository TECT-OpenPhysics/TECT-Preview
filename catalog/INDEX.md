...
**5751 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,084,972 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1399 | 43,508,643 |
| Domain codes (`code`) | 1083 | 19,654,232 |
| Verification harness (`verification`) | 372 | 12,881,287 |
...
| Other tracked files (`other`) | 668 | 15,605,632 |
