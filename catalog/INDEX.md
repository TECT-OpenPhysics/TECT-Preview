...
**4486 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,069,447 |
| Working proof notes (on claim cards) (`proof-note`) | 924 | 107,651,126 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1070 | 29,890,230 |
| Domain codes (`code`) | 783 | 17,002,867 |
| Verification harness (`verification`) | 101 | 11,192,937 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,548,029 |
| Governance policies (`policy`) | 21 | 197,756 |
| Root documents (`root-doc`) | 14 | 1,714,855 |
| Other tracked files (`other`) | 306 | 11,723,842 |
