...
**5900 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,088,812 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1444 | 54,491,377 |
| Domain codes (`code`) | 1128 | 20,072,072 |
| Verification harness (`verification`) | 388 | 13,060,533 |
...
| Other tracked files (`other`) | 711 | 16,026,121 |
