...
**4871 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1153 | 32,364,099 |
| Domain codes (`code`) | 840 | 17,470,632 |
| Verification harness (`verification`) | 279 | 11,798,799 |
...
| Other tracked files (`other`) | 370 | 12,850,613 |
