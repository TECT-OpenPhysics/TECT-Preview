...
**5557 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,585 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1344 | 41,730,095 |
| Domain codes (`code`) | 1026 | 19,118,334 |
| Verification harness (`verification`) | 349 | 12,591,783 |
...
| Other tracked files (`other`) | 609 | 14,980,392 |
