...
**5426 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,007 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1305 | 40,835,420 |
| Domain codes (`code`) | 987 | 18,723,575 |
| Verification harness (`verification`) | 335 | 12,438,279 |
...
| Other tracked files (`other`) | 570 | 14,597,635 |
