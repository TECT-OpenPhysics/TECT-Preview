...
**6048 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,092,631 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1489 | 54,958,664 |
| Domain codes (`code`) | 1173 | 20,482,968 |
| Verification harness (`verification`) | 406 | 13,244,680 |
...
| Other tracked files (`other`) | 750 | 16,449,429 |
