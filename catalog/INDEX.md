...
**8343 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,140,004 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2173 | 269,698,383 |
| Domain codes (`code`) | 1786 | 28,381,611 |
| Verification harness (`verification`) | 707 | 19,201,467 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,585,387 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,159,917 |
| Other tracked files (`other`) | 1354 | 25,873,805 |
