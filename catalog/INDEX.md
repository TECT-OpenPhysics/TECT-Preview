...
**5882 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,088,342 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1438 | 54,457,866 |
| Domain codes (`code`) | 1122 | 20,025,961 |
| Verification harness (`verification`) | 386 | 13,035,161 |
...
| Other tracked files (`other`) | 707 | 15,975,199 |
