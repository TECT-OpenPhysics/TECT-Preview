...
**5320 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,077,154 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1276 | 40,618,807 |
| Domain codes (`code`) | 954 | 18,446,778 |
| Verification harness (`verification`) | 324 | 12,336,949 |
...
| Other tracked files (`other`) | 537 | 14,324,323 |
