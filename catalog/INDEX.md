...
**8382 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,140,114 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2178 | 269,794,300 |
| Domain codes (`code`) | 1789 | 28,411,592 |
| Verification harness (`verification`) | 713 | 19,489,208 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,585,057 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,164,846 |
| Other tracked files (`other`) | 1379 | 26,361,204 |
