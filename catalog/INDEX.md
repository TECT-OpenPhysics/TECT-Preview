...
**7060 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,118,224 |
| Working proof notes (on claim cards) (`proof-note`) | 969 | 107,261,757 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1795 | 161,198,028 |
| Domain codes (`code`) | 1479 | 24,733,459 |
| Verification harness (`verification`) | 504 | 14,742,511 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,682 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,837,794 |
| Other tracked files (`other`) | 1010 | 19,510,052 |
