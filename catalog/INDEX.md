...
**6356 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,101,578 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1591 | 64,082,901 |
| Domain codes (`code`) | 1275 | 21,764,923 |
| Verification harness (`verification`) | 434 | 13,646,915 |
...
| Other tracked files (`other`) | 826 | 17,429,105 |
