...
**6658 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,109,399 |
| Working proof notes (on claim cards) (`proof-note`) | 936 | 107,211,350 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1681 | 94,673,628 |
| Domain codes (`code`) | 1365 | 23,119,318 |
| Verification harness (`verification`) | 467 | 14,097,234 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,561,671 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,752,272 |
| Other tracked files (`other`) | 906 | 18,373,311 |
