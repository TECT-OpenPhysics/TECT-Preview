...
**7073 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,118,595 |
| Working proof notes (on claim cards) (`proof-note`) | 970 | 107,263,722 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1799 | 169,876,887 |
| Domain codes (`code`) | 1483 | 24,782,569 |
| Verification harness (`verification`) | 505 | 14,761,546 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,648 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,840,691 |
| Other tracked files (`other`) | 1013 | 19,545,948 |
