...
**5219 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,063 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1246 | 34,402,718 |
| Domain codes (`code`) | 924 | 18,192,591 |
| Verification harness (`verification`) | 313 | 12,236,570 |
...
| Other tracked files (`other`) | 507 | 14,066,387 |
