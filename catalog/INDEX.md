...
**6381 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,102,373 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1600 | 64,415,136 |
| Domain codes (`code`) | 1284 | 21,915,029 |
| Verification harness (`verification`) | 435 | 13,682,622 |
...
| Other tracked files (`other`) | 832 | 17,527,172 |
