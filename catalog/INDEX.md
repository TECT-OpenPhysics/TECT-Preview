...
**7192 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,121,370 |
| Working proof notes (on claim cards) (`proof-note`) | 979 | 107,278,506 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1835 | 171,732,066 |
| Domain codes (`code`) | 1519 | 25,379,601 |
| Verification harness (`verification`) | 516 | 14,935,080 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,750 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,870,802 |
| Other tracked files (`other`) | 1040 | 19,858,444 |
