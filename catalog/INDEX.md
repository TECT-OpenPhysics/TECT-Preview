...
**7859 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,135,677 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2031 | 233,699,835 |
| Domain codes (`code`) | 1691 | 27,202,979 |
| Verification harness (`verification`) | 609 | 16,852,005 |
...
| Other tracked files (`other`) | 1234 | 22,797,912 |
