...
**5036 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,611 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1192 | 33,161,899 |
| Domain codes (`code`) | 870 | 17,729,579 |
| Verification harness (`verification`) | 293 | 12,068,158 |
...
| Other tracked files (`other`) | 452 | 13,648,786 |
