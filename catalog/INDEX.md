...
**5507 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,115 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1329 | 41,312,193 |
| Domain codes (`code`) | 1011 | 18,959,854 |
| Verification harness (`verification`) | 344 | 12,533,386 |
...
| Other tracked files (`other`) | 594 | 14,838,727 |
