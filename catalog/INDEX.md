...
**7206 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,121,677 |
| Working proof notes (on claim cards) (`proof-note`) | 980 | 107,280,277 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1839 | 171,890,082 |
| Domain codes (`code`) | 1523 | 25,448,300 |
| Verification harness (`verification`) | 518 | 14,956,285 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,796 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,873,834 |
| Other tracked files (`other`) | 1043 | 19,894,162 |
