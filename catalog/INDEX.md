...
**6008 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,091,625 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1477 | 54,796,654 |
| Domain codes (`code`) | 1161 | 20,372,923 |
| Verification harness (`verification`) | 401 | 13,201,324 |
...
| Other tracked files (`other`) | 739 | 16,343,832 |
