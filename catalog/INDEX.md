...
**7633 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,131,128 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1971 | 207,114,964 |
| Domain codes (`code`) | 1655 | 26,917,604 |
| Verification harness (`verification`) | 558 | 15,779,785 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,792 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 1,982,227 |
| Other tracked files (`other`) | 1155 | 21,346,515 |
