...
**3819 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 4,996,008 |
| Working proof notes (on claim cards) (`proof-note`) | 890 | 106,504,712 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 926 | 23,723,759 |
| Domain codes (`code`) | 670 | 14,516,502 |
| Verification harness (`verification`) | 40 | 9,046,414 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,283,991 |
| Governance policies (`policy`) | 19 | 147,226 |
| Root documents (`root-doc`) | 14 | 1,484,390 |
| Other tracked files (`other`) | 202 | 9,140,325 |
