...
**6246 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,098,304 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1552 | 61,305,167 |
| Domain codes (`code`) | 1236 | 21,258,394 |
| Verification harness (`verification`) | 428 | 13,495,266 |
...
| Other tracked files (`other`) | 800 | 17,044,199 |
