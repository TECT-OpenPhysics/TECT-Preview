...
**6612 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,108,333 |
| Working proof notes (on claim cards) (`proof-note`) | 932 | 107,206,218 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1669 | 94,302,428 |
| Domain codes (`code`) | 1353 | 22,878,256 |
| Verification harness (`verification`) | 461 | 14,019,646 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,558,687 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,741,292 |
| Other tracked files (`other`) | 894 | 18,261,596 |
