...
**7797 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,134,072 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2010 | 210,631,320 |
| Domain codes (`code`) | 1681 | 27,115,233 |
| Verification harness (`verification`) | 594 | 16,572,064 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,747 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,024,969 |
| Other tracked files (`other`) | 1218 | 22,529,194 |
