...
**4994 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,255 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1180 | 33,074,996 |
| Domain codes (`code`) | 858 | 17,652,776 |
| Verification harness (`verification`) | 288 | 12,024,389 |
...
| Other tracked files (`other`) | 439 | 13,542,456 |
