...
**5598 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,081,126 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1356 | 42,106,342 |
| Domain codes (`code`) | 1038 | 19,262,787 |
| Verification harness (`verification`) | 354 | 12,640,529 |
...
| Other tracked files (`other`) | 621 | 15,094,917 |
