...
**7662 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 564 | 15,937,864 |
...
| Root documents (`root-doc`) | 14 | 1,986,962 |
| Other tracked files (`other`) | 1170 | 21,646,581 |
