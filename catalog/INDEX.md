...
**7668 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 15,984,031 |
...
| Root documents (`root-doc`) | 14 | 1,987,441 |
| Other tracked files (`other`) | 1175 | 21,769,576 |
