...
**5386 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,632 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1293 | 40,740,724 |
| Domain codes (`code`) | 975 | 18,623,360 |
| Verification harness (`verification`) | 331 | 12,399,665 |
...
| Other tracked files (`other`) | 558 | 14,496,387 |
