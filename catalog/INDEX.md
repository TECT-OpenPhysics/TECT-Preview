...
**7671 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 16,038,722 |
...
| Root documents (`root-doc`) | 14 | 1,988,639 |
| Other tracked files (`other`) | 1178 | 21,875,729 |
