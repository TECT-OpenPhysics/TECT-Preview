...
**5097 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,059 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1210 | 34,052,911 |
| Domain codes (`code`) | 888 | 17,878,965 |
| Verification harness (`verification`) | 299 | 12,125,145 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,549,113 |
| Governance policies (`policy`) | 21 | 198,378 |
| Root documents (`root-doc`) | 14 | 1,726,543 |
| Other tracked files (`other`) | 471 | 13,786,572 |
