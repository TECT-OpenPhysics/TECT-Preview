...
**7219 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,121,992 |
| Working proof notes (on claim cards) (`proof-note`) | 981 | 107,281,963 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1843 | 172,053,857 |
| Domain codes (`code`) | 1527 | 25,514,437 |
| Verification harness (`verification`) | 519 | 14,977,487 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,875 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,877,538 |
| Other tracked files (`other`) | 1046 | 19,931,935 |
