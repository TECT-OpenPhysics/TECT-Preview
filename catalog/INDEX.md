...
**7652 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 561 | 15,838,471 |
...
| Root documents (`root-doc`) | 14 | 1,986,508 |
| Other tracked files (`other`) | 1163 | 21,480,664 |
