...
**5087 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,982 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1207 | 33,984,496 |
| Domain codes (`code`) | 885 | 17,854,492 |
| Verification harness (`verification`) | 298 | 12,116,606 |
...
| Other tracked files (`other`) | 468 | 13,766,248 |
