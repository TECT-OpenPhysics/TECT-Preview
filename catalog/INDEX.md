...
**7623 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,130,849 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1967 | 207,081,617 |
| Domain codes (`code`) | 1651 | 26,874,965 |
| Verification harness (`verification`) | 558 | 15,760,037 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,795 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 1,978,774 |
| Other tracked files (`other`) | 1153 | 21,317,642 |
