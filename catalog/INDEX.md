...
**6116 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,094,519 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1510 | 55,291,576 |
| Domain codes (`code`) | 1194 | 20,697,755 |
| Verification harness (`verification`) | 413 | 13,325,957 |
...
| Other tracked files (`other`) | 769 | 16,663,269 |
