...
**5864 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,087,848 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1432 | 45,339,600 |
| Domain codes (`code`) | 1116 | 19,971,807 |
| Verification harness (`verification`) | 384 | 13,010,487 |
...
| Other tracked files (`other`) | 703 | 15,925,145 |
