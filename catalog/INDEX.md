...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,060,928 |
...
| Verification harness (`verification`) | 49 | 10,511,478 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,532,738 |
| Governance policies (`policy`) | 21 | 195,650 |
| Root documents (`root-doc`) | 14 | 1,652,273 |
| Other tracked files (`other`) | 258 | 11,151,969 |
