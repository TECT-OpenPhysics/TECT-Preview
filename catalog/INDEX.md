...
**5987 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,091,137 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1471 | 54,715,429 |
| Domain codes (`code`) | 1155 | 20,302,784 |
| Verification harness (`verification`) | 398 | 13,175,968 |
...
| Other tracked files (`other`) | 733 | 16,280,926 |
