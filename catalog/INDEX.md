...
**8328 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,139,943 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2169 | 269,581,093 |
| Domain codes (`code`) | 1783 | 28,315,314 |
| Verification harness (`verification`) | 703 | 18,993,600 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,584,963 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,154,348 |
| Other tracked files (`other`) | 1350 | 25,585,156 |
