...
**6254 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,098,572 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1555 | 61,502,721 |
| Domain codes (`code`) | 1239 | 21,286,835 |
| Verification harness (`verification`) | 428 | 13,505,536 |
...
| Other tracked files (`other`) | 802 | 17,070,894 |
