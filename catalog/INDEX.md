...
**6993 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,116,561 |
| Working proof notes (on claim cards) (`proof-note`) | 964 | 107,253,509 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1775 | 129,141,016 |
| Domain codes (`code`) | 1459 | 24,478,702 |
| Verification harness (`verification`) | 498 | 14,646,597 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,841 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,824,130 |
| Other tracked files (`other`) | 994 | 19,336,689 |
