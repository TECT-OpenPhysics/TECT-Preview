...
**5158 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,561 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1228 | 34,232,657 |
| Domain codes (`code`) | 906 | 18,033,925 |
| Verification harness (`verification`) | 306 | 12,182,718 |
...
| Other tracked files (`other`) | 489 | 13,924,127 |
