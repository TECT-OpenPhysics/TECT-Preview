...
**6147 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,095,356 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1519 | 56,023,862 |
| Domain codes (`code`) | 1203 | 20,801,354 |
| Verification harness (`verification`) | 417 | 13,360,429 |
...
| Other tracked files (`other`) | 778 | 16,738,883 |
