...
**6201 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,096,955 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1537 | 56,741,623 |
| Domain codes (`code`) | 1221 | 21,055,255 |
| Verification harness (`verification`) | 423 | 13,431,474 |
...
| Other tracked files (`other`) | 790 | 16,896,884 |
