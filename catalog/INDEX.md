...
**4886 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,444,167 |
| Domain codes (`code`) | 840 | 17,471,921 |
| Verification harness (`verification`) | 280 | 11,827,505 |
...
| Other tracked files (`other`) | 381 | 12,945,494 |
