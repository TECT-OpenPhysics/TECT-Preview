...
**7644 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 559 | 15,802,338 |
...
| Root documents (`root-doc`) | 14 | 1,985,996 |
| Other tracked files (`other`) | 1157 | 21,379,698 |
