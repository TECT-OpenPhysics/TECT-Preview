...
**7670 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 16,019,962 |
...
| Root documents (`root-doc`) | 14 | 1,988,214 |
| Other tracked files (`other`) | 1177 | 21,839,697 |
