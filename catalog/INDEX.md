...
**5436 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,111 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1308 | 40,902,224 |
| Domain codes (`code`) | 990 | 18,758,054 |
| Verification harness (`verification`) | 336 | 12,449,271 |
...
| Other tracked files (`other`) | 573 | 14,626,578 |
