...
**5547 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,484 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1341 | 41,669,004 |
| Domain codes (`code`) | 1023 | 19,087,324 |
| Verification harness (`verification`) | 348 | 12,580,086 |
...
| Other tracked files (`other`) | 606 | 14,953,188 |
