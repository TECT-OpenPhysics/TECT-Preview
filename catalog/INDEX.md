...
**6136 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,095,094 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1516 | 55,505,592 |
| Domain codes (`code`) | 1200 | 20,763,226 |
| Verification harness (`verification`) | 415 | 13,348,801 |
...
| Other tracked files (`other`) | 775 | 16,713,580 |
