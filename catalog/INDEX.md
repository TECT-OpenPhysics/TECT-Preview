...
**8186 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,139,479 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2133 | 239,035,150 |
| Domain codes (`code`) | 1756 | 27,905,624 |
| Verification harness (`verification`) | 676 | 17,989,013 |
| Papers (publication layer) (`paper`) | 8 | 152,031 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,582,392 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,120,463 |
| Other tracked files (`other`) | 1319 | 24,358,488 |
