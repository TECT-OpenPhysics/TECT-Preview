...
**5189 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,807 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1237 | 34,335,894 |
| Domain codes (`code`) | 915 | 18,113,965 |
| Verification harness (`verification`) | 310 | 12,208,995 |
...
| Other tracked files (`other`) | 498 | 13,991,023 |
