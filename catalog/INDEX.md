...
**5854 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,087,565 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1429 | 45,317,940 |
| Domain codes (`code`) | 1113 | 19,951,641 |
| Verification harness (`verification`) | 383 | 12,996,180 |
...
| Other tracked files (`other`) | 700 | 15,895,170 |
