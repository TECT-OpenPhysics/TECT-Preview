...
**7113 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,119,596 |
| Working proof notes (on claim cards) (`proof-note`) | 973 | 107,269,205 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1811 | 170,575,352 |
| Domain codes (`code`) | 1495 | 24,939,028 |
| Verification harness (`verification`) | 509 | 14,820,245 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,604 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,850,442 |
| Other tracked files (`other`) | 1022 | 19,652,610 |
