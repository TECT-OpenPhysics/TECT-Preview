...
**8650 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,142,785 |
| Working proof notes (on claim cards) (`proof-note`) | 996 | 108,082,756 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2244 | 274,452,619 |
| Domain codes (`code`) | 1801 | 28,497,277 |
| Verification harness (`verification`) | 788 | 20,946,025 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,597,807 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,227,794 |
| Other tracked files (`other`) | 1488 | 28,235,638 |
