...
**5771 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,085,532 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1405 | 43,552,703 |
| Domain codes (`code`) | 1089 | 19,706,419 |
| Verification harness (`verification`) | 374 | 12,904,008 |
...
| Other tracked files (`other`) | 674 | 15,660,833 |
