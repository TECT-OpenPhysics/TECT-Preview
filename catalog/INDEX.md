...
**6872 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,113,929 |
| Working proof notes (on claim cards) (`proof-note`) | 955 | 107,238,916 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1739 | 98,416,862 |
| Domain codes (`code`) | 1423 | 24,037,209 |
| Verification harness (`verification`) | 488 | 14,468,288 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,298 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,799,136 |
| Other tracked files (`other`) | 964 | 18,997,189 |
