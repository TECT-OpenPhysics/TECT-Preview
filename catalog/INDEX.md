...
**5229 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,148 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1249 | 34,424,947 |
| Domain codes (`code`) | 927 | 18,217,770 |
| Verification harness (`verification`) | 314 | 12,245,393 |
...
| Other tracked files (`other`) | 510 | 14,089,120 |
