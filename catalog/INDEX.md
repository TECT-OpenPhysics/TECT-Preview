...
**5517 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,203 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1332 | 41,380,391 |
| Domain codes (`code`) | 1014 | 18,997,052 |
| Verification harness (`verification`) | 345 | 12,546,731 |
...
| Other tracked files (`other`) | 597 | 14,872,797 |
