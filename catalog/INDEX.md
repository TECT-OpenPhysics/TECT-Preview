...
**6347 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,101,340 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1588 | 64,042,912 |
| Domain codes (`code`) | 1272 | 21,723,564 |
| Verification harness (`verification`) | 433 | 13,634,804 |
...
| Other tracked files (`other`) | 824 | 17,398,673 |
