...
**5677 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,082,984 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1377 | 43,291,483 |
| Domain codes (`code`) | 1059 | 19,450,130 |
| Verification harness (`verification`) | 363 | 12,794,292 |
...
| Other tracked files (`other`) | 649 | 15,405,403 |
