...
**5685 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,083,069 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1378 | 43,301,463 |
| Domain codes (`code`) | 1062 | 19,480,904 |
| Verification harness (`verification`) | 364 | 12,808,159 |
...
| Other tracked files (`other`) | 652 | 15,436,493 |
