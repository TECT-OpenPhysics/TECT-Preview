...
**7307 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,124,133 |
| Working proof notes (on claim cards) (`proof-note`) | 986 | 107,289,829 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1871 | 180,733,793 |
| Domain codes (`code`) | 1555 | 25,852,978 |
| Verification harness (`verification`) | 526 | 15,114,032 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,567,319 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,902,367 |
| Other tracked files (`other`) | 1066 | 20,191,984 |
