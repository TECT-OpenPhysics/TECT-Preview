...
**5117 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,221 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1216 | 34,103,322 |
| Domain codes (`code`) | 894 | 17,928,976 |
| Verification harness (`verification`) | 301 | 12,143,512 |
...
| Other tracked files (`other`) | 477 | 13,830,838 |
