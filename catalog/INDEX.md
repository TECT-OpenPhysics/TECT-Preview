...
**7785 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,133,733 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2006 | 210,223,426 |
| Domain codes (`code`) | 1679 | 27,096,340 |
| Verification harness (`verification`) | 591 | 16,513,172 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,702 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,020,014 |
| Other tracked files (`other`) | 1215 | 22,484,140 |
