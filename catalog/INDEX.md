...
**5568 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,683 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1347 | 41,783,209 |
| Domain codes (`code`) | 1029 | 19,148,964 |
| Verification harness (`verification`) | 351 | 12,604,187 |
...
| Other tracked files (`other`) | 612 | 15,007,543 |
