...
**5977 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,090,902 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1468 | 54,691,509 |
| Domain codes (`code`) | 1152 | 20,269,227 |
| Verification harness (`verification`) | 397 | 13,163,585 |
...
| Other tracked files (`other`) | 730 | 16,250,012 |
