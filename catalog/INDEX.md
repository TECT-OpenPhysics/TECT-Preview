...
**6156 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,095,606 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1522 | 56,084,845 |
| Domain codes (`code`) | 1206 | 20,832,521 |
| Verification harness (`verification`) | 418 | 13,371,142 |
...
| Other tracked files (`other`) | 780 | 16,762,134 |
