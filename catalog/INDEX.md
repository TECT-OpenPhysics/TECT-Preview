...
**5137 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,397 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1222 | 34,150,584 |
| Domain codes (`code`) | 900 | 17,980,559 |
| Verification harness (`verification`) | 303 | 12,163,029 |
...
| Other tracked files (`other`) | 483 | 13,878,751 |
