...
**7678 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,131,449 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1976 | 207,151,849 |
| Domain codes (`code`) | 1659 | 26,944,221 |
| Verification harness (`verification`) | 566 | 16,105,964 |
...
| Root documents (`root-doc`) | 14 | 1,990,223 |
| Other tracked files (`other`) | 1183 | 22,009,271 |
