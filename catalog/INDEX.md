...
**7649 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 560 | 15,824,531 |
...
| Root documents (`root-doc`) | 14 | 1,986,291 |
| Other tracked files (`other`) | 1161 | 21,437,761 |
