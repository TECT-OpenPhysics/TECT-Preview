...
**5703 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,083,590 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1384 | 43,391,830 |
| Domain codes (`code`) | 1068 | 19,542,656 |
| Verification harness (`verification`) | 366 | 12,829,768 |
...
| Other tracked files (`other`) | 656 | 15,483,752 |
