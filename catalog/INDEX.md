...
**7675 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 16,076,866 |
...
| Root documents (`root-doc`) | 14 | 1,989,590 |
| Other tracked files (`other`) | 1182 | 21,979,570 |
