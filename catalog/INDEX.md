...
**6454 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,104,487 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1624 | 72,943,701 |
| Domain codes (`code`) | 1308 | 22,230,700 |
| Verification harness (`verification`) | 444 | 13,788,415 |
...
| Other tracked files (`other`) | 848 | 17,771,793 |
