...
**5487 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,710 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1323 | 41,089,641 |
| Domain codes (`code`) | 1005 | 18,890,175 |
| Verification harness (`verification`) | 342 | 12,512,436 |
...
| Other tracked files (`other`) | 588 | 14,782,164 |
