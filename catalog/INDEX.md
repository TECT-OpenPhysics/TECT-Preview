...
**4917 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,617,519 |
| Domain codes (`code`) | 840 | 17,494,042 |
| Verification harness (`verification`) | 281 | 11,925,923 |
...
| Other tracked files (`other`) | 411 | 13,291,712 |
