...
**5628 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,081,936 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1365 | 42,270,649 |
| Domain codes (`code`) | 1047 | 19,335,011 |
| Verification harness (`verification`) | 357 | 12,685,435 |
...
| Other tracked files (`other`) | 630 | 15,186,132 |
