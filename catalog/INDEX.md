...
**5309 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,859 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1273 | 40,595,130 |
| Domain codes (`code`) | 951 | 18,418,731 |
| Verification harness (`verification`) | 322 | 12,326,789 |
...
| Other tracked files (`other`) | 534 | 14,295,154 |
