...
**5467 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,465 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1317 | 41,014,096 |
| Domain codes (`code`) | 999 | 18,836,617 |
| Verification harness (`verification`) | 340 | 12,485,675 |
...
| Other tracked files (`other`) | 582 | 14,719,977 |
