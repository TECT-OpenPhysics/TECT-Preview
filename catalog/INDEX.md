...
**6408 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,103,120 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1609 | 68,316,768 |
| Domain codes (`code`) | 1293 | 22,036,650 |
| Verification harness (`verification`) | 438 | 13,721,432 |
...
| Other tracked files (`other`) | 838 | 17,620,641 |
