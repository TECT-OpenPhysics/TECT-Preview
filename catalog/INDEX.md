...
**6568 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,107,354 |
| Working proof notes (on claim cards) (`proof-note`) | 928 | 107,200,486 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1657 | 94,030,446 |
| Domain codes (`code`) | 1341 | 22,696,351 |
| Verification harness (`verification`) | 457 | 13,940,186 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,556,129 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,729,958 |
| Other tracked files (`other`) | 882 | 18,136,397 |
