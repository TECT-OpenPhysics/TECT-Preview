...
**7294 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,123,874 |
| Working proof notes (on claim cards) (`proof-note`) | 985 | 107,287,407 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1867 | 180,608,915 |
| Domain codes (`code`) | 1551 | 25,811,953 |
| Verification harness (`verification`) | 525 | 15,095,623 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,566,535 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,899,519 |
| Other tracked files (`other`) | 1063 | 20,155,964 |
