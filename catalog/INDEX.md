...
**7268 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,123,236 |
| Working proof notes (on claim cards) (`proof-note`) | 984 | 107,286,205 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1859 | 180,180,275 |
| Domain codes (`code`) | 1543 | 25,719,352 |
| Verification harness (`verification`) | 522 | 15,056,293 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,871 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,891,818 |
| Other tracked files (`other`) | 1057 | 20,076,369 |
