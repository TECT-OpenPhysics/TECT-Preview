...
**5891 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,088,583 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1441 | 54,474,116 |
| Domain codes (`code`) | 1125 | 20,048,366 |
| Verification harness (`verification`) | 387 | 13,046,761 |
...
| Other tracked files (`other`) | 709 | 16,000,119 |
