...
**5269 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,514 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1261 | 40,358,844 |
| Domain codes (`code`) | 939 | 18,326,815 |
| Verification harness (`verification`) | 318 | 12,287,046 |
...
| Other tracked files (`other`) | 522 | 14,193,245 |
