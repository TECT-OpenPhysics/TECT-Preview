...
**3826 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 5,003,092 |
| Working proof notes (on claim cards) (`proof-note`) | 896 | 107,227,542 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 926 | 24,655,920 |
| Domain codes (`code`) | 670 | 14,989,698 |
| Verification harness (`verification`) | 40 | 9,220,594 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,325,455 |
| Governance policies (`policy`) | 19 | 149,265 |
| Root documents (`root-doc`) | 14 | 1,507,465 |
| Other tracked files (`other`) | 203 | 9,427,270 |
