...
**4923 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,813,404 |
| Domain codes (`code`) | 840 | 17,502,085 |
| Verification harness (`verification`) | 281 | 11,946,464 |
...
| Other tracked files (`other`) | 417 | 13,363,003 |
