...
**5047 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,692 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1195 | 33,185,996 |
| Domain codes (`code`) | 873 | 17,755,862 |
| Verification harness (`verification`) | 294 | 12,084,114 |
...
| Other tracked files (`other`) | 456 | 13,685,298 |
