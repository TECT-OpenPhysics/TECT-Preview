...
**7673 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 16,057,237 |
...
| Root documents (`root-doc`) | 14 | 1,989,101 |
| Other tracked files (`other`) | 1180 | 21,925,204 |
