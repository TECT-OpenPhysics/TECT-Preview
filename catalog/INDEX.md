...
**4475 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,069,374 |
| Working proof notes (on claim cards) (`proof-note`) | 923 | 107,650,342 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1067 | 29,853,848 |
| Domain codes (`code`) | 781 | 16,983,363 |
| Verification harness (`verification`) | 99 | 11,157,712 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,547,466 |
| Governance policies (`policy`) | 21 | 197,248 |
| Root documents (`root-doc`) | 14 | 1,711,885 |
| Other tracked files (`other`) | 303 | 11,695,328 |
