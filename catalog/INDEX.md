...
**5368 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,443 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1289 | 40,702,996 |
| Domain codes (`code`) | 969 | 18,566,070 |
| Verification harness (`verification`) | 329 | 12,380,184 |
...
| Other tracked files (`other`) | 552 | 14,441,671 |
