...
**5004 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,340 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1183 | 33,089,787 |
| Domain codes (`code`) | 861 | 17,675,583 |
| Verification harness (`verification`) | 289 | 12,034,010 |
...
| Other tracked files (`other`) | 442 | 13,567,783 |
