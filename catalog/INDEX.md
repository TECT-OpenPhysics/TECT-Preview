...
**4904 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,452,313 |
| Domain codes (`code`) | 840 | 17,476,442 |
| Verification harness (`verification`) | 280 | 11,879,565 |
...
| Other tracked files (`other`) | 399 | 13,139,696 |
