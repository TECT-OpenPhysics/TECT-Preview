...
**7086 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,118,958 |
| Working proof notes (on claim cards) (`proof-note`) | 971 | 107,265,744 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1803 | 170,004,554 |
| Domain codes (`code`) | 1487 | 24,837,166 |
| Verification harness (`verification`) | 506 | 14,780,089 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,609 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,843,570 |
| Other tracked files (`other`) | 1016 | 19,579,914 |
