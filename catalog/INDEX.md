...
**6270 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,099,093 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1561 | 62,249,568 |
| Domain codes (`code`) | 1245 | 21,379,329 |
| Verification harness (`verification`) | 428 | 13,528,243 |
...
| Other tracked files (`other`) | 806 | 17,130,367 |
