...
**6319 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,100,623 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1579 | 63,635,764 |
| Domain codes (`code`) | 1263 | 21,628,255 |
| Verification harness (`verification`) | 429 | 13,598,845 |
...
| Other tracked files (`other`) | 818 | 17,312,393 |
