...
**3979 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 5,028,265 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 986 | 28,629,692 |
| Domain codes (`code`) | 721 | 16,292,822 |
| Verification harness (`verification`) | 40 | 9,882,133 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,500,020 |
| Governance policies (`policy`) | 19 | 173,290 |
| Root documents (`root-doc`) | 14 | 1,622,520 |
| Other tracked files (`other`) | 239 | 10,613,081 |
