...
**6364 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,101,819 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1594 | 64,143,143 |
| Domain codes (`code`) | 1278 | 21,819,782 |
| Verification harness (`verification`) | 434 | 13,658,809 |
...
| Other tracked files (`other`) | 828 | 17,462,477 |
