...
**5803 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,086,222 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1414 | 43,665,813 |
| Domain codes (`code`) | 1098 | 19,784,142 |
| Verification harness (`verification`) | 377 | 12,946,001 |
...
| Other tracked files (`other`) | 685 | 15,761,981 |
