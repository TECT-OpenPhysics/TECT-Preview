...
**5360 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,355 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1288 | 40,695,006 |
| Domain codes (`code`) | 966 | 18,541,969 |
| Verification harness (`verification`) | 328 | 12,371,159 |
...
| Other tracked files (`other`) | 549 | 14,414,733 |
