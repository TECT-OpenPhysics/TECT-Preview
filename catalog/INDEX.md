...
**6278 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,099,388 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1564 | 62,965,465 |
| Domain codes (`code`) | 1248 | 21,433,001 |
| Verification harness (`verification`) | 428 | 13,540,719 |
...
| Other tracked files (`other`) | 808 | 17,162,876 |
