...
**7985 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,138,036 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2071 | 238,436,174 |
| Domain codes (`code`) | 1714 | 27,424,171 |
| Verification harness (`verification`) | 638 | 17,241,388 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,825 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,071,194 |
| Other tracked files (`other`) | 1268 | 23,172,646 |
