...
**6262 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,098,825 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1558 | 61,673,322 |
| Domain codes (`code`) | 1242 | 21,333,888 |
| Verification harness (`verification`) | 428 | 13,516,860 |
...
| Other tracked files (`other`) | 804 | 17,100,953 |
