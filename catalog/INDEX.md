...
**7931 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,137,076 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2055 | 236,718,417 |
| Domain codes (`code`) | 1703 | 27,292,085 |
| Verification harness (`verification`) | 627 | 17,113,237 |
...
| Root documents (`root-doc`) | 14 | 2,058,618 |
| Other tracked files (`other`) | 1252 | 23,008,173 |
