...
**3753 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 4,981,065 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 905 | 21,369,259 |
| Domain codes (`code`) | 649 | 12,960,213 |
| Verification harness (`verification`) | 40 | 8,742,666 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,178,768 |
| Governance policies (`policy`) | 19 | 143,435 |
| Root documents (`root-doc`) | 14 | 1,433,284 |
| Other tracked files (`other`) | 188 | 8,622,772 |
