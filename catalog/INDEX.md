...
**6183 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,096,458 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1531 | 56,326,030 |
| Domain codes (`code`) | 1215 | 20,959,102 |
| Verification harness (`verification`) | 421 | 13,407,325 |
...
| Other tracked files (`other`) | 786 | 16,842,028 |
