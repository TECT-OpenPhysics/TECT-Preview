...
**5608 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,081,406 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1359 | 42,126,938 |
| Domain codes (`code`) | 1041 | 19,286,177 |
| Verification harness (`verification`) | 355 | 12,652,498 |
...
| Other tracked files (`other`) | 624 | 15,124,766 |
