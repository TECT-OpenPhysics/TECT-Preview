...
**9516 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,152,466 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2510 | 279,805,355 |
| Domain codes (`code`) | 1912 | 29,271,388 |
| Verification harness (`verification`) | 985 | 23,858,329 |
...
| Other tracked files (`other`) | 1757 | 31,549,536 |
