...
**4880 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,073,654 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,410,279 |
| Domain codes (`code`) | 840 | 17,470,951 |
| Verification harness (`verification`) | 280 | 11,812,498 |
...
| Other tracked files (`other`) | 375 | 12,889,787 |
