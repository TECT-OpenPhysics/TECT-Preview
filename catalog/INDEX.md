...
**6445 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,104,216 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1621 | 71,774,213 |
| Domain codes (`code`) | 1305 | 22,193,729 |
| Verification harness (`verification`) | 443 | 13,775,284 |
...
| Other tracked files (`other`) | 846 | 17,742,366 |
