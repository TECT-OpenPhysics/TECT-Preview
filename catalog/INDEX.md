...
**5107 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,139 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1213 | 34,077,968 |
| Domain codes (`code`) | 891 | 17,902,724 |
| Verification harness (`verification`) | 300 | 12,133,854 |
...
| Other tracked files (`other`) | 474 | 13,807,012 |
