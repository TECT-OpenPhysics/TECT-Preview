...
**6533 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,106,577 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1648 | 78,349,883 |
| Domain codes (`code`) | 1332 | 22,549,722 |
| Verification harness (`verification`) | 452 | 13,883,805 |
...
| Other tracked files (`other`) | 871 | 18,010,742 |
