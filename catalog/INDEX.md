...
**6165 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,095,892 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1525 | 56,142,134 |
| Domain codes (`code`) | 1209 | 20,870,299 |
| Verification harness (`verification`) | 419 | 13,382,381 |
...
| Other tracked files (`other`) | 782 | 16,786,390 |
