...
**6513 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,106,050 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1642 | 74,817,874 |
| Domain codes (`code`) | 1326 | 22,434,998 |
| Verification harness (`verification`) | 450 | 13,858,821 |
...
| Other tracked files (`other`) | 865 | 17,943,278 |
