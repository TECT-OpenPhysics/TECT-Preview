...
**5928 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,089,559 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1453 | 54,551,747 |
| Domain codes (`code`) | 1137 | 20,138,901 |
| Verification harness (`verification`) | 392 | 13,093,654 |
...
| Other tracked files (`other`) | 717 | 16,098,389 |
