...
**6820 artefacts** · **49 live claim cards** ·
...
| Working proof notes (on claim cards) (`proof-note`) | 951 | 107,231,941 |
...
| Verification harness (`verification`) | 484 | 14,385,512 |
...
| Other tracked files (`other`) | 952 | 18,842,024 |
