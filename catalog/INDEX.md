...
**7945 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,137,323 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2059 | 238,308,653 |
| Domain codes (`code`) | 1705 | 27,309,837 |
| Verification harness (`verification`) | 632 | 17,163,272 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,793 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,062,778 |
| Other tracked files (`other`) | 1255 | 23,048,560 |
