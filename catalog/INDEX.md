...
**7738 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,132,706 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1994 | 207,415,238 |
| Domain codes (`code`) | 1671 | 27,034,929 |
| Verification harness (`verification`) | 577 | 16,325,646 |
...
| Root documents (`root-doc`) | 14 | 2,003,853 |
| Other tracked files (`other`) | 1202 | 22,317,510 |
