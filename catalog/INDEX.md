...
**5537 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,403 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1338 | 41,610,612 |
| Domain codes (`code`) | 1020 | 19,060,151 |
| Verification harness (`verification`) | 347 | 12,569,433 |
...
| Other tracked files (`other`) | 603 | 14,929,146 |
