...
**3743 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 4,980,496 |
| Working proof notes (on claim cards) (`proof-note`) | 878 | 105,683,871 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 902 | 21,110,813 |
| Domain codes (`code`) | 646 | 12,789,928 |
| Verification harness (`verification`) | 40 | 8,700,872 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,163,414 |
| Governance policies (`policy`) | 19 | 142,788 |
| Root documents (`root-doc`) | 14 | 1,426,986 |
| Other tracked files (`other`) | 186 | 8,558,271 |
