...
**5578 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,774 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1350 | 41,853,211 |
| Domain codes (`code`) | 1032 | 19,189,287 |
| Verification harness (`verification`) | 352 | 12,616,037 |
...
| Other tracked files (`other`) | 615 | 15,036,171 |
