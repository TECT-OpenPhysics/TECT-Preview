...
**6192 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,096,708 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1534 | 56,583,441 |
| Domain codes (`code`) | 1218 | 21,010,345 |
| Verification harness (`verification`) | 422 | 13,419,722 |
...
| Other tracked files (`other`) | 788 | 16,869,996 |
