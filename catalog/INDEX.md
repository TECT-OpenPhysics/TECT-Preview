...
**6038 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,092,381 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1486 | 54,900,156 |
| Domain codes (`code`) | 1170 | 20,453,773 |
| Verification harness (`verification`) | 405 | 13,234,532 |
...
| Other tracked files (`other`) | 747 | 16,423,745 |
