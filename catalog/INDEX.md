...
**7681 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,131,492 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1977 | 207,166,320 |
| Domain codes (`code`) | 1659 | 26,944,221 |
| Verification harness (`verification`) | 567 | 16,129,825 |
...
| Root documents (`root-doc`) | 14 | 1,990,732 |
| Other tracked files (`other`) | 1184 | 22,037,154 |
