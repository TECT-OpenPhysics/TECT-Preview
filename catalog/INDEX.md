...
**5722 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,084,141 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1390 | 43,421,004 |
| Domain codes (`code`) | 1074 | 19,582,069 |
| Verification harness (`verification`) | 369 | 12,849,415 |
...
| Other tracked files (`other`) | 660 | 15,528,071 |
