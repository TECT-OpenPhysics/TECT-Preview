...
**3821 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 4,998,319 |
| Working proof notes (on claim cards) (`proof-note`) | 892 | 106,662,339 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 926 | 24,210,192 |
| Domain codes (`code`) | 670 | 14,769,253 |
| Verification harness (`verification`) | 40 | 9,110,622 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,300,364 |
| Governance policies (`policy`) | 19 | 148,027 |
| Root documents (`root-doc`) | 14 | 1,493,536 |
| Other tracked files (`other`) | 202 | 9,254,550 |
