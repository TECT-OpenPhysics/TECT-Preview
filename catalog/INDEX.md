...
**7320 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,124,364 |
| Working proof notes (on claim cards) (`proof-note`) | 987 | 107,291,751 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1875 | 180,885,073 |
| Domain codes (`code`) | 1559 | 25,899,069 |
| Verification harness (`verification`) | 527 | 15,133,589 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,568,074 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,905,256 |
| Other tracked files (`other`) | 1069 | 20,228,274 |
