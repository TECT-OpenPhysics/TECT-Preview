...
**6555 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,107,122 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1654 | 93,988,420 |
| Domain codes (`code`) | 1338 | 22,647,636 |
| Verification harness (`verification`) | 456 | 13,908,387 |
...
| Other tracked files (`other`) | 877 | 18,071,542 |
