...
**6210 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,097,220 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1540 | 57,532,501 |
| Domain codes (`code`) | 1224 | 21,108,266 |
| Verification harness (`verification`) | 424 | 13,444,244 |
...
| Other tracked files (`other`) | 792 | 16,927,327 |
