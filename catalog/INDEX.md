...
**6126 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,094,799 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1513 | 55,362,540 |
| Domain codes (`code`) | 1197 | 20,727,712 |
| Verification harness (`verification`) | 414 | 13,337,559 |
...
| Other tracked files (`other`) | 772 | 16,688,231 |
