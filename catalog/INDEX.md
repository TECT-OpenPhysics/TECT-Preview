...
**5731 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,084,418 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1393 | 43,436,670 |
| Domain codes (`code`) | 1077 | 19,602,509 |
| Verification harness (`verification`) | 370 | 12,858,935 |
...
| Other tracked files (`other`) | 662 | 15,546,752 |
