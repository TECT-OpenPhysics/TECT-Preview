...
**7100 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,119,293 |
| Working proof notes (on claim cards) (`proof-note`) | 972 | 107,267,491 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1807 | 170,289,701 |
| Domain codes (`code`) | 1491 | 24,883,530 |
| Verification harness (`verification`) | 508 | 14,800,256 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,614 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,846,832 |
| Other tracked files (`other`) | 1019 | 19,615,290 |
