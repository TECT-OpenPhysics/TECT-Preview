...
**5814 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,086,463 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1417 | 43,752,966 |
| Domain codes (`code`) | 1101 | 19,820,629 |
| Verification harness (`verification`) | 379 | 12,957,951 |
...
| Other tracked files (`other`) | 688 | 15,794,034 |
