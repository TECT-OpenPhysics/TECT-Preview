...
**5396 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,725 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1296 | 40,757,819 |
| Domain codes (`code`) | 978 | 18,644,367 |
| Verification harness (`verification`) | 332 | 12,408,546 |
...
| Other tracked files (`other`) | 561 | 14,519,559 |
