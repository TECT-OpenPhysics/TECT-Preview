...
**4261 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,065,836 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1007 | 28,975,900 |
| Domain codes (`code`) | 739 | 16,646,394 |
| Verification harness (`verification`) | 53 | 10,576,479 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,533,600 |
| Governance policies (`policy`) | 21 | 195,650 |
| Root documents (`root-doc`) | 14 | 1,653,647 |
| Other tracked files (`other`) | 258 | 11,195,300 |
