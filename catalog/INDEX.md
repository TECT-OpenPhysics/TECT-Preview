...
**5025 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,520 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1189 | 33,147,524 |
| Domain codes (`code`) | 867 | 17,713,428 |
| Verification harness (`verification`) | 292 | 12,052,326 |
...
| Other tracked files (`other`) | 448 | 13,612,851 |
