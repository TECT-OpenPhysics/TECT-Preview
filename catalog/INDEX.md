...
**6859 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,113,819 |
| Working proof notes (on claim cards) (`proof-note`) | 954 | 107,237,122 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1735 | 98,298,629 |
| Domain codes (`code`) | 1419 | 24,001,055 |
| Verification harness (`verification`) | 487 | 14,447,430 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,353 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,796,295 |
| Other tracked files (`other`) | 961 | 18,960,445 |
