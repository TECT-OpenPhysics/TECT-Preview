...
**5873 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,088,128 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1435 | 45,896,702 |
| Domain codes (`code`) | 1119 | 20,004,580 |
| Verification harness (`verification`) | 385 | 13,021,956 |
...
| Other tracked files (`other`) | 705 | 15,950,741 |
