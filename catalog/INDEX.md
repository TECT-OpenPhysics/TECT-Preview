...
**5350 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,075 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1285 | 40,678,439 |
| Domain codes (`code`) | 963 | 18,520,342 |
| Verification harness (`verification`) | 327 | 12,362,862 |
...
| Other tracked files (`other`) | 546 | 14,392,590 |
