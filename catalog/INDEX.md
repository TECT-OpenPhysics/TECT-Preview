...
**6078 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,093,366 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1498 | 55,179,798 |
| Domain codes (`code`) | 1182 | 20,578,145 |
| Verification harness (`verification`) | 409 | 13,278,131 |
...
| Other tracked files (`other`) | 759 | 16,537,661 |
