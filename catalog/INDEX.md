...
**3867 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 5,015,924 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 944 | 27,779,349 |
| Domain codes (`code`) | 679 | 15,459,348 |
| Verification harness (`verification`) | 40 | 9,514,124 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,397,031 |
| Governance policies (`policy`) | 19 | 154,665 |
| Root documents (`root-doc`) | 14 | 1,550,151 |
| Other tracked files (`other`) | 211 | 9,891,093 |
