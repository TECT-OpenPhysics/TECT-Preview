...
**5127 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,301 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1219 | 34,126,107 |
| Domain codes (`code`) | 897 | 17,950,825 |
| Verification harness (`verification`) | 302 | 12,152,533 |
...
| Other tracked files (`other`) | 480 | 13,852,395 |
