...
**6228 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,097,792 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1546 | 61,013,244 |
| Domain codes (`code`) | 1230 | 21,190,168 |
| Verification harness (`verification`) | 426 | 13,471,957 |
...
| Other tracked files (`other`) | 796 | 16,986,636 |
