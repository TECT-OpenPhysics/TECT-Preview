...
**6544 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,106,848 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1651 | 85,874,661 |
| Domain codes (`code`) | 1335 | 22,608,539 |
| Verification harness (`verification`) | 454 | 13,897,035 |
...
| Other tracked files (`other`) | 874 | 18,046,258 |
