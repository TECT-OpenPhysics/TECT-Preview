...
**5669 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,082,713 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1374 | 42,679,669 |
| Domain codes (`code`) | 1056 | 19,411,075 |
| Verification harness (`verification`) | 363 | 12,785,302 |
...
| Other tracked files (`other`) | 647 | 15,383,173 |
