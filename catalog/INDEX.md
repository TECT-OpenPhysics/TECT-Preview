...
**5446 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,222 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1311 | 40,924,996 |
| Domain codes (`code`) | 993 | 18,783,797 |
| Verification harness (`verification`) | 337 | 12,461,085 |
...
| Other tracked files (`other`) | 576 | 14,658,365 |
