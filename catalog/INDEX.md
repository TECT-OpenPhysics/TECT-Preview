...
**4932 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,073,766 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1162 | 32,908,695 |
| Domain codes (`code`) | 840 | 17,502,085 |
| Verification harness (`verification`) | 281 | 11,955,223 |
...
| Other tracked files (`other`) | 420 | 13,390,331 |
