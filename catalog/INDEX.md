...
**5781 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,085,833 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1408 | 43,576,249 |
| Domain codes (`code`) | 1092 | 19,733,192 |
| Verification harness (`verification`) | 375 | 12,916,146 |
...
| Other tracked files (`other`) | 677 | 15,689,602 |
