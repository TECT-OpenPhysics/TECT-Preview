...
**6463 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,104,752 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1627 | 72,999,250 |
| Domain codes (`code`) | 1311 | 22,264,125 |
| Verification harness (`verification`) | 445 | 13,800,487 |
...
| Other tracked files (`other`) | 850 | 17,799,538 |
