...
**5694 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,083,331 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1381 | 43,356,921 |
| Domain codes (`code`) | 1065 | 19,511,733 |
| Verification harness (`verification`) | 365 | 12,816,133 |
...
| Other tracked files (`other`) | 654 | 15,456,072 |
