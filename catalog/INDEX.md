...
**5299 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,765 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1270 | 40,540,497 |
| Domain codes (`code`) | 948 | 18,395,853 |
| Verification harness (`verification`) | 321 | 12,316,562 |
...
| Other tracked files (`other`) | 531 | 14,267,215 |
