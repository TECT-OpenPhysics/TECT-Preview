...
**5948 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,090,119 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1459 | 54,615,008 |
| Domain codes (`code`) | 1143 | 20,191,545 |
| Verification harness (`verification`) | 394 | 13,126,566 |
...
| Other tracked files (`other`) | 722 | 16,164,870 |
