...
**6373 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,102,105 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1597 | 64,255,367 |
| Domain codes (`code`) | 1281 | 21,874,134 |
| Verification harness (`verification`) | 435 | 13,671,267 |
...
| Other tracked files (`other`) | 830 | 17,495,388 |
