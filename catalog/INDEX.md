...
**5997 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,091,378 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1474 | 54,750,976 |
| Domain codes (`code`) | 1158 | 20,336,816 |
| Verification harness (`verification`) | 399 | 13,188,247 |
...
| Other tracked files (`other`) | 736 | 16,310,852 |
