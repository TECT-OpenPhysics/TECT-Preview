...
**5527 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,302 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1335 | 41,407,461 |
| Domain codes (`code`) | 1017 | 19,028,647 |
| Verification harness (`verification`) | 346 | 12,558,451 |
...
| Other tracked files (`other`) | 600 | 14,903,693 |
