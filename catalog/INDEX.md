...
**5147 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,473 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1225 | 34,178,221 |
| Domain codes (`code`) | 903 | 18,009,560 |
| Verification harness (`verification`) | 304 | 12,173,558 |
...
| Other tracked files (`other`) | 486 | 13,902,668 |
