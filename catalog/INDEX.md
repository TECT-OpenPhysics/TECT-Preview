...
**7774 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,133,462 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2003 | 209,706,880 |
| Domain codes (`code`) | 1677 | 27,078,292 |
| Verification harness (`verification`) | 588 | 16,463,108 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,710 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,015,646 |
| Other tracked files (`other`) | 1212 | 22,440,401 |
