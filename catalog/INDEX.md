...
**6426 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,103,662 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1615 | 69,755,314 |
| Domain codes (`code`) | 1299 | 22,116,621 |
| Verification harness (`verification`) | 440 | 13,747,212 |
...
| Other tracked files (`other`) | 842 | 17,681,349 |
