...
**5289 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,689 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1267 | 40,494,244 |
| Domain codes (`code`) | 945 | 18,375,683 |
| Verification harness (`verification`) | 320 | 12,307,348 |
...
| Other tracked files (`other`) | 528 | 14,243,725 |
