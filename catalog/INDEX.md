...
**6390 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,102,626 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1603 | 65,733,058 |
| Domain codes (`code`) | 1287 | 21,957,410 |
| Verification harness (`verification`) | 436 | 13,695,425 |
...
| Other tracked files (`other`) | 834 | 17,558,516 |
