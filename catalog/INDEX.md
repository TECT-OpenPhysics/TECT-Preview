...
**8628 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,142,526 |
| Working proof notes (on claim cards) (`proof-note`) | 994 | 107,696,361 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2236 | 274,398,597 |
| Domain codes (`code`) | 1798 | 28,482,110 |
| Verification harness (`verification`) | 784 | 20,915,406 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,597,672 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,223,702 |
| Other tracked files (`other`) | 1483 | 28,168,115 |
