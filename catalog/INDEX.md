...
**4895 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,456,345 |
| Domain codes (`code`) | 840 | 17,473,297 |
| Verification harness (`verification`) | 280 | 11,851,567 |
...
| Other tracked files (`other`) | 390 | 13,036,060 |
