...
**5967 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,090,652 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1465 | 54,662,942 |
| Domain codes (`code`) | 1149 | 20,235,631 |
| Verification harness (`verification`) | 396 | 13,151,275 |
...
| Other tracked files (`other`) | 727 | 16,220,024 |
