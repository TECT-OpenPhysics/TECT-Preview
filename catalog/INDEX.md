...
**5909 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,089,059 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1447 | 54,511,350 |
| Domain codes (`code`) | 1131 | 20,093,452 |
| Verification harness (`verification`) | 389 | 13,071,761 |
...
| Other tracked files (`other`) | 713 | 16,050,923 |
