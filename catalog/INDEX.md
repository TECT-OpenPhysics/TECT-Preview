...
**4883 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,423,330 |
| Domain codes (`code`) | 840 | 17,471,261 |
| Verification harness (`verification`) | 280 | 11,819,895 |
...
| Other tracked files (`other`) | 378 | 12,915,823 |
