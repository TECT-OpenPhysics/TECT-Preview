...
**6417 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,103,388 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1612 | 69,545,644 |
| Domain codes (`code`) | 1296 | 22,078,877 |
| Verification harness (`verification`) | 439 | 13,734,223 |
...
| Other tracked files (`other`) | 840 | 17,650,747 |
