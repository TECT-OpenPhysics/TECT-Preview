...
**6435 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,103,936 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1618 | 69,919,869 |
| Domain codes (`code`) | 1302 | 22,153,251 |
| Verification harness (`verification`) | 441 | 13,760,587 |
...
| Other tracked files (`other`) | 844 | 17,711,865 |
