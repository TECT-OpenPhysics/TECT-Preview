...
**6068 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,093,110 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1495 | 55,138,772 |
| Domain codes (`code`) | 1179 | 20,551,831 |
| Verification harness (`verification`) | 408 | 13,266,510 |
...
| Other tracked files (`other`) | 756 | 16,508,891 |
