...
**6793 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,112,843 |
| Working proof notes (on claim cards) (`proof-note`) | 948 | 107,227,255 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1717 | 95,706,092 |
| Domain codes (`code`) | 1401 | 23,695,176 |
| Verification harness (`verification`) | 481 | 14,334,597 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,519 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,782,940 |
| Other tracked files (`other`) | 943 | 18,741,124 |
