...
**6058 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,092,854 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1492 | 55,043,436 |
| Domain codes (`code`) | 1176 | 20,515,868 |
| Verification harness (`verification`) | 407 | 13,255,768 |
...
| Other tracked files (`other`) | 753 | 16,479,580 |
