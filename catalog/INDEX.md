...
**4972 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,097 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1174 | 33,043,831 |
| Domain codes (`code`) | 852 | 17,609,816 |
| Verification harness (`verification`) | 285 | 12,001,778 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,549,179 |
| Governance policies (`policy`) | 21 | 198,378 |
| Root documents (`root-doc`) | 14 | 1,726,543 |
| Other tracked files (`other`) | 432 | 13,497,076 |
