...
**7871 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,135,900 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2035 | 234,023,381 |
| Domain codes (`code`) | 1693 | 27,223,817 |
| Verification harness (`verification`) | 612 | 16,905,274 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,802 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,053,768 |
| Other tracked files (`other`) | 1237 | 22,840,692 |
