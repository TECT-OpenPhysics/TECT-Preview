...
**5199 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,891 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1240 | 34,356,831 |
| Domain codes (`code`) | 918 | 18,139,516 |
| Verification harness (`verification`) | 311 | 12,217,959 |
...
| Other tracked files (`other`) | 501 | 14,013,873 |
