...
**4272 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,068,033 |
| Working proof notes (on claim cards) (`proof-note`) | 903 | 107,631,279 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1009 | 28,996,092 |
| Domain codes (`code`) | 741 | 16,656,610 |
| Verification harness (`verification`) | 57 | 10,626,891 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,533,287 |
| Governance policies (`policy`) | 21 | 195,650 |
| Root documents (`root-doc`) | 14 | 1,654,311 |
| Other tracked files (`other`) | 260 | 11,237,458 |
