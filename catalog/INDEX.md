...
**5761 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,085,243 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1402 | 43,529,947 |
| Domain codes (`code`) | 1086 | 19,675,850 |
| Verification harness (`verification`) | 373 | 12,892,108 |
...
| Other tracked files (`other`) | 671 | 15,633,009 |
