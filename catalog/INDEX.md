...
**4864 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,073,599 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1150 | 32,345,933 |
| Domain codes (`code`) | 839 | 17,462,890 |
| Verification harness (`verification`) | 279 | 11,791,975 |
...
| Other tracked files (`other`) | 367 | 12,832,018 |
