...
**4984 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,176 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1177 | 33,059,127 |
| Domain codes (`code`) | 855 | 17,631,759 |
| Verification harness (`verification`) | 287 | 12,013,280 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,549,145 |
| Governance policies (`policy`) | 21 | 198,378 |
| Root documents (`root-doc`) | 14 | 1,726,543 |
| Other tracked files (`other`) | 436 | 13,520,972 |
