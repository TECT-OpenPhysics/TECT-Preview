...
**6523 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,106,321 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1645 | 75,767,382 |
| Domain codes (`code`) | 1329 | 22,487,253 |
| Verification harness (`verification`) | 451 | 13,871,316 |
...
| Other tracked files (`other`) | 868 | 17,976,643 |
