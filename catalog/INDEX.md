...
**6951 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,115,512 |
| Working proof notes (on claim cards) (`proof-note`) | 961 | 107,248,768 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1763 | 115,920,789 |
| Domain codes (`code`) | 1447 | 24,331,088 |
| Verification harness (`verification`) | 495 | 14,583,569 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,563,949 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,815,693 |
| Other tracked files (`other`) | 982 | 19,207,548 |
