...
**5014 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,431 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1186 | 33,129,937 |
| Domain codes (`code`) | 864 | 17,697,187 |
| Verification harness (`verification`) | 290 | 12,043,133 |
...
| Other tracked files (`other`) | 445 | 13,590,890 |
