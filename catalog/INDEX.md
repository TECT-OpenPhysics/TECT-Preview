...
**6018 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,091,884 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1480 | 54,815,644 |
| Domain codes (`code`) | 1164 | 20,394,879 |
| Verification harness (`verification`) | 402 | 13,212,514 |
...
| Other tracked files (`other`) | 742 | 16,372,087 |
