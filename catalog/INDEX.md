...
**5477 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,079,609 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1320 | 41,059,818 |
| Domain codes (`code`) | 1002 | 18,864,154 |
| Verification harness (`verification`) | 341 | 12,499,429 |
...
| Other tracked files (`other`) | 585 | 14,752,530 |
