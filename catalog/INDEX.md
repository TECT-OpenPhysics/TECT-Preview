...
**6088 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,093,664 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1501 | 55,201,188 |
| Domain codes (`code`) | 1185 | 20,602,090 |
| Verification harness (`verification`) | 410 | 13,289,951 |
...
| Other tracked files (`other`) | 762 | 16,569,375 |
