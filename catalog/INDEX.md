...
**7971 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,137,789 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2067 | 238,407,637 |
| Domain codes (`code`) | 1711 | 27,393,611 |
| Verification harness (`verification`) | 636 | 17,209,986 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,761 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,066,733 |
| Other tracked files (`other`) | 1263 | 23,126,858 |
