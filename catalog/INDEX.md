...
**8228 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,139,628 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2145 | 268,129,528 |
| Domain codes (`code`) | 1765 | 28,036,876 |
| Verification harness (`verification`) | 684 | 18,146,037 |
| Papers (publication layer) (`paper`) | 9 | 189,312 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,582,341 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,130,001 |
| Other tracked files (`other`) | 1331 | 24,563,681 |
