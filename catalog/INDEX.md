...
**6302 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,100,153 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1573 | 63,601,402 |
| Domain codes (`code`) | 1257 | 21,578,587 |
| Verification harness (`verification`) | 428 | 13,576,229 |
...
| Other tracked files (`other`) | 814 | 17,257,863 |
