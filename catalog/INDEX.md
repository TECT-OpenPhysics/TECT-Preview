...
**5279 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,610 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1264 | 40,403,060 |
| Domain codes (`code`) | 942 | 18,350,093 |
| Verification harness (`verification`) | 319 | 12,297,199 |
...
| Other tracked files (`other`) | 525 | 14,218,806 |
