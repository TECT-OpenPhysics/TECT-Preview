...
**5169 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,646 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1231 | 34,256,247 |
| Domain codes (`code`) | 909 | 18,057,423 |
| Verification harness (`verification`) | 308 | 12,190,553 |
...
| Other tracked files (`other`) | 492 | 13,943,353 |
