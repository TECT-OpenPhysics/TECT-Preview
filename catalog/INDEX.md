...
**5791 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,086,131 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1411 | 43,601,193 |
| Domain codes (`code`) | 1095 | 19,754,758 |
| Verification harness (`verification`) | 376 | 12,927,388 |
...
| Other tracked files (`other`) | 680 | 15,715,429 |
