...
**4411 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,068,981 |
| Working proof notes (on claim cards) (`proof-note`) | 917 | 107,643,719 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1049 | 29,434,779 |
| Domain codes (`code`) | 769 | 16,880,011 |
| Verification harness (`verification`) | 85 | 10,968,269 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,542,599 |
| Governance policies (`policy`) | 21 | 195,650 |
| Root documents (`root-doc`) | 14 | 1,692,542 |
| Other tracked files (`other`) | 289 | 11,513,981 |
