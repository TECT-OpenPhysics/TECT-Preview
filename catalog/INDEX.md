...
**5918 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,089,297 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1450 | 54,532,986 |
| Domain codes (`code`) | 1134 | 20,115,931 |
| Verification harness (`verification`) | 390 | 13,082,717 |
...
| Other tracked files (`other`) | 715 | 16,075,211 |
