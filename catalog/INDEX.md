...
**6328 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,100,855 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1582 | 63,652,869 |
| Domain codes (`code`) | 1266 | 21,648,532 |
| Verification harness (`verification`) | 430 | 13,610,413 |
...
| Other tracked files (`other`) | 820 | 17,338,406 |
