...
**5330 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,077,443 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1279 | 40,640,299 |
| Domain codes (`code`) | 957 | 18,476,210 |
| Verification harness (`verification`) | 325 | 12,345,688 |
...
| Other tracked files (`other`) | 540 | 14,347,129 |
