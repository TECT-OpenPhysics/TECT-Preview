...
**4907 artefacts** · **49 live claim cards** ·
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1156 | 32,454,310 |
| Domain codes (`code`) | 840 | 17,479,131 |
| Verification harness (`verification`) | 280 | 11,890,164 |
...
| Other tracked files (`other`) | 402 | 13,177,105 |
