...
**6338 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,101,099 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1585 | 63,984,890 |
| Domain codes (`code`) | 1269 | 21,682,159 |
| Verification harness (`verification`) | 432 | 13,623,410 |
...
| Other tracked files (`other`) | 822 | 17,368,764 |
