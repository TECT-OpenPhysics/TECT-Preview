...
**7333 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,124,587 |
| Working proof notes (on claim cards) (`proof-note`) | 988 | 107,293,263 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1879 | 181,066,368 |
| Domain codes (`code`) | 1563 | 25,943,369 |
| Verification harness (`verification`) | 528 | 15,153,581 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,568,054 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,907,612 |
| Other tracked files (`other`) | 1072 | 20,263,615 |
