...
**5939 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,089,833 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1456 | 54,589,895 |
| Domain codes (`code`) | 1140 | 20,167,095 |
| Verification harness (`verification`) | 393 | 13,114,187 |
...
| Other tracked files (`other`) | 720 | 16,138,249 |
