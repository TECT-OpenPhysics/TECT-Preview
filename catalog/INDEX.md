...
**5618 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,081,710 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1362 | 42,242,768 |
| Domain codes (`code`) | 1044 | 19,314,541 |
| Verification harness (`verification`) | 356 | 12,665,012 |
...
| Other tracked files (`other`) | 627 | 15,154,490 |
