...
**7727 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,132,456 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1991 | 207,276,592 |
| Domain codes (`code`) | 1669 | 27,018,779 |
| Verification harness (`verification`) | 574 | 16,280,009 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,754 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 1,999,841 |
| Other tracked files (`other`) | 1199 | 22,278,881 |
