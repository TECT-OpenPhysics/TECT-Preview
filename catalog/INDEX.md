...
**7658 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 563 | 15,900,424 |
...
| Root documents (`root-doc`) | 14 | 1,986,755 |
| Other tracked files (`other`) | 1167 | 21,588,082 |
