...
**5340 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,077,765 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1282 | 40,658,765 |
| Domain codes (`code`) | 960 | 18,497,743 |
| Verification harness (`verification`) | 326 | 12,354,035 |
...
| Other tracked files (`other`) | 543 | 14,368,401 |
