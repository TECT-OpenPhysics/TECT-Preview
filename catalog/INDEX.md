...
**7655 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,131,403 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1975 | 207,148,529 |
| Domain codes (`code`) | 1659 | 26,944,221 |
| Verification harness (`verification`) | 562 | 15,868,279 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,770 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 1,986,557 |
| Other tracked files (`other`) | 1165 | 21,545,531 |
