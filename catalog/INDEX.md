...
**5376 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,078,536 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1290 | 40,711,231 |
| Domain codes (`code`) | 972 | 18,592,136 |
| Verification harness (`verification`) | 330 | 12,389,505 |
...
| Other tracked files (`other`) | 555 | 14,468,459 |
