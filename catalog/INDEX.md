...
**6782 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,112,527 |
| Working proof notes (on claim cards) (`proof-note`) | 947 | 107,225,426 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1714 | 95,611,643 |
| Domain codes (`code`) | 1398 | 23,642,649 |
| Verification harness (`verification`) | 480 | 14,315,173 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,564,534 |
| Governance policies (`policy`) | 22 | 201,476 |
| Root documents (`root-doc`) | 14 | 1,780,539 |
| Other tracked files (`other`) | 940 | 18,706,854 |
