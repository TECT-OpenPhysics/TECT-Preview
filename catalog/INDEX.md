...
**7666 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 565 | 15,969,924 |
...
| Root documents (`root-doc`) | 14 | 1,987,167 |
| Other tracked files (`other`) | 1173 | 21,731,737 |
