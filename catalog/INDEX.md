...
**6174 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,096,169 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1528 | 56,212,382 |
| Domain codes (`code`) | 1212 | 20,914,389 |
| Verification harness (`verification`) | 420 | 13,394,903 |
...
| Other tracked files (`other`) | 784 | 16,813,960 |
