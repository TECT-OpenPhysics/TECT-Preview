...
**4942 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,073,846 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1165 | 32,939,802 |
| Domain codes (`code`) | 843 | 17,533,266 |
| Verification harness (`verification`) | 282 | 11,965,740 |
...
| Other tracked files (`other`) | 423 | 13,416,446 |
