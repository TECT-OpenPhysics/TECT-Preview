...
**3824 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 600 | 5,001,753 |
| Working proof notes (on claim cards) (`proof-note`) | 894 | 107,110,627 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 926 | 24,578,129 |
| Domain codes (`code`) | 670 | 14,929,257 |
| Verification harness (`verification`) | 40 | 9,180,535 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,317,538 |
| Governance policies (`policy`) | 19 | 148,789 |
| Root documents (`root-doc`) | 14 | 1,501,329 |
| Other tracked files (`other`) | 203 | 9,366,739 |
