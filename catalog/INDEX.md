...
**5179 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,075,732 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1234 | 34,313,180 |
| Domain codes (`code`) | 912 | 18,091,445 |
| Verification harness (`verification`) | 309 | 12,200,289 |
...
| Other tracked files (`other`) | 495 | 13,969,123 |
