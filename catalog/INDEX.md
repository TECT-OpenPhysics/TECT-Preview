...
**6028 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,092,116 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1483 | 54,867,012 |
| Domain codes (`code`) | 1167 | 20,429,737 |
| Verification harness (`verification`) | 403 | 13,224,123 |
...
| Other tracked files (`other`) | 745 | 16,400,567 |
