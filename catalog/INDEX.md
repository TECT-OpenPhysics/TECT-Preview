...
**5239 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,076,240 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1252 | 34,555,128 |
| Domain codes (`code`) | 930 | 18,246,039 |
| Verification harness (`verification`) | 315 | 12,254,958 |
...
| Other tracked files (`other`) | 513 | 14,113,540 |
