...
**5824 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,086,743 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1420 | 44,481,080 |
| Domain codes (`code`) | 1104 | 19,860,673 |
| Verification harness (`verification`) | 380 | 12,968,030 |
...
| Other tracked files (`other`) | 691 | 15,821,731 |
