...
**8499 artefacts** · **49 live claim cards** ·
...
| Verification harness (`verification`) | 748 | 20,274,964 |
| Papers (publication layer) (`paper`) | 29 | 523,659 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,587,636 |
| Governance policies (`policy`) | 24 | 227,425 |
| Root documents (`root-doc`) | 14 | 2,189,435 |
| Other tracked files (`other`) | 1434 | 27,369,382 |
