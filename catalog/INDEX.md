...
**5067 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,074,836 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1201 | 33,939,223 |
| Domain codes (`code`) | 879 | 17,807,690 |
| Verification harness (`verification`) | 296 | 12,099,737 |
...
| Other tracked files (`other`) | 462 | 13,723,870 |
