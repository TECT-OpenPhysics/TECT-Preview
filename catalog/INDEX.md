...
**6310 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,100,406 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1576 | 63,622,390 |
| Domain codes (`code`) | 1260 | 21,608,561 |
| Verification harness (`verification`) | 428 | 13,587,542 |
...
| Other tracked files (`other`) | 816 | 17,287,101 |
