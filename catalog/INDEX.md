...
**7856 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,135,631 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2030 | 233,696,941 |
| Domain codes (`code`) | 1691 | 27,202,979 |
| Verification harness (`verification`) | 608 | 16,823,585 |
| Papers (publication layer) (`paper`) | 1 | 546 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,573,745 |
| Governance policies (`policy`) | 23 | 215,824 |
| Root documents (`root-doc`) | 14 | 2,049,778 |
| Other tracked files (`other`) | 1233 | 22,756,267 |
