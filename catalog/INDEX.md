...
**8738 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,144,334 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 2270 | 275,940,544 |
| Domain codes (`code`) | 1804 | 28,514,383 |
| Verification harness (`verification`) | 811 | 21,340,349 |
| Papers (publication layer) (`paper`) | 45 | 729,120 |
| Website (publication layer) (`website`) | 4 | 20,775 |
| Registries and ledgers (`registry`) | 42 | 1,600,808 |
| Governance policies (`policy`) | 25 | 236,063 |
| Root documents (`root-doc`) | 14 | 2,232,546 |
| Other tracked files (`other`) | 1505 | 28,604,515 |
