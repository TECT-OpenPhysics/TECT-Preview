...
**5588 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,080,958 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1353 | 41,917,858 |
| Domain codes (`code`) | 1035 | 19,228,058 |
| Verification harness (`verification`) | 353 | 12,628,517 |
...
| Other tracked files (`other`) | 618 | 15,065,902 |
