...
**5957 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,090,393 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1462 | 54,640,305 |
| Domain codes (`code`) | 1146 | 20,213,153 |
| Verification harness (`verification`) | 395 | 13,138,707 |
...
| Other tracked files (`other`) | 724 | 16,190,916 |
