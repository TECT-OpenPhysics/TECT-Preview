...
**6238 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,098,036 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1549 | 61,236,663 |
| Domain codes (`code`) | 1233 | 21,221,068 |
| Verification harness (`verification`) | 428 | 13,484,833 |
...
| Other tracked files (`other`) | 798 | 17,016,875 |
