...
**6399 artefacts** · **49 live claim cards** ·
...
|---|---:|---:|
| Claim cards (registry layer) (`claim-card`) | 604 | 5,102,861 |
...
| Fresh run artefacts (TSv2 evidence) (`run-artefact`) | 1606 | 66,786,610 |
| Domain codes (`code`) | 1290 | 21,997,544 |
| Verification harness (`verification`) | 437 | 13,707,841 |
...
| Other tracked files (`other`) | 836 | 17,589,665 |
