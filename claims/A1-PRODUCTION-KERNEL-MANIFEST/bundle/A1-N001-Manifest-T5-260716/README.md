...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `A1-N001-Manifest-T5-260716`.
...
## Contents
- the referee note (proof, self-contained): `claims/A1-PRODUCTION-KERNEL-MANIFEST/notes/a1-production-kernel-manifest-260623-260716-v1.7.tex.txt`
  (+ its `.pdf`)
