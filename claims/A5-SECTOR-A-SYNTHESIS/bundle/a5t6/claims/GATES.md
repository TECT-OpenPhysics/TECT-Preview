...
bundle is built last beside the immutable T5 capstone.  Closure does not
authorize T7 or assert a full derivative Class-II measure, BCC selection, or
physical-domain closure.
...
`b-a4`.  The A5 review gate remains closed and the
...
claim-level bundle `b-a4` passes all three entry
