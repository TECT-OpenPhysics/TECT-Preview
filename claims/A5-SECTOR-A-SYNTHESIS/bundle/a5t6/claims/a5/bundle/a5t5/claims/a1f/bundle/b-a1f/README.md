...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `b-a1f`.
...
## Contents
- the referee note (proof, self-contained): `claims/a1f/notes/a1-production-functional-realisation-260717-v1.3.tex.txt`
  (+ its `.pdf`)
