...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `b-a4`.
...
## Contents
- the referee note (proof, self-contained): `claims/a4/notes/a4-scalar-constructive-referee-package-260719-v2.1.tex.txt`
  (+ its `.pdf`)
