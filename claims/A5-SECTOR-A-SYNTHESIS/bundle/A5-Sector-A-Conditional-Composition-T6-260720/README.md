...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `A5-Sector-A-Conditional-Composition-T6-260720`.
...
## Contents
- the referee note (proof, self-contained): `claims/A5-SECTOR-A-SYNTHESIS/notes/a5-t6-conditional-composition-referee-package-260719-260720-v1.1.tex.txt`
  (+ its `.pdf`)
