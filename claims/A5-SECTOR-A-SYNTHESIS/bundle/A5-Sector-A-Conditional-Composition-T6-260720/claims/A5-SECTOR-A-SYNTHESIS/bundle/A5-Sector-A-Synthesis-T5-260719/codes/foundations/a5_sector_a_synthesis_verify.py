...
DEFAULT_OUTPUT = CLAIM / "runs" / "2026-07-19-t5-capstone-preflight" / "result.json"
...
def main() -> int:
    ...
    output = {
        ...
        "failures": failures,
        "promotion_boundary": "T5 CLOSED@BRANCH-AWARE-SECTOR-A-SYNTHESIS; all six support bundles are PUBLISHED; exact A5 v1.2 package confirmation is required before capstone PUBLISHED packaging",
