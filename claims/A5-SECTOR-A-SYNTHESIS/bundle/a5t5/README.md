...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `a5t5`.
...
## Contents
- the referee note (proof, self-contained): `claims/a5/notes/a5-sector-a-synthesis-referee-package-260718-260719-v1.2.tex.txt`
  (+ its `.pdf`)
