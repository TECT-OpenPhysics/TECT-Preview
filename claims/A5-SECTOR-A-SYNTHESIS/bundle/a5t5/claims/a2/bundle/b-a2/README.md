...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `b-a2`.
...
## Contents
- the referee note (proof, self-contained): `claims/a2/notes/a2-full-production-wellposedness-260717-v2.0.tex.txt`
  (+ its `.pdf`)
