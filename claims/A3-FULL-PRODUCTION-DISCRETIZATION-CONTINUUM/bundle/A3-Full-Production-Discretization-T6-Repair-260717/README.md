...
**Bundle grade:** PUBLISHED (operator-confirmed) -- `A3-Full-Production-Discretization-T6-Repair-260717`.
...
## Contents
- the referee note (proof, self-contained): `claims/A3-FULL-PRODUCTION-DISCRETIZATION-CONTINUUM/notes/a3-full-production-discretization-continuum-260717-v2.2.tex.txt`
  (+ its `.pdf`)
