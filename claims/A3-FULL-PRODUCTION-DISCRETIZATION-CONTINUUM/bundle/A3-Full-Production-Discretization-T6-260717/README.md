# Reproduction bundle -- Full-production spectral Galerkin convergence conditional theorem

Self-contained referee reproduction bundle (TECT verification-first repository).
Built 20260717T130427Z with Python 3.12.10, numpy 1.26.4,
and torch 2.11.0+cpu.

**Bundle grade:** PUBLISHED (operator-confirmed) -- `A3-Full-Production-Discretization-T6-260717`.
...
## Contents
- the referee note (proof, self-contained): `claims/A3-FULL-PRODUCTION-DISCRETIZATION-CONTINUUM/notes/a3-full-production-discretization-continuum-260717-v2.1.tex.txt`
  (+ its `.pdf`)
...
pip install -r requirements.txt        # dependencies discovered from entry scripts
  ...
  python codes/foundations/a3_full_production_verify.py
```
...
## Expected (must match)
  ...
  a3_full_production_hardware_precision: exit 0, `cpu_complex64: PASS`
  ...
  a3_full_production_verify: exit 0, `A3-FULL-PRODUCTION-VERIFY-PASS`
