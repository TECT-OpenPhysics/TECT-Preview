...
**Notes**: 27 files / 26 note-lineages  ·  **Runs**: 80  ·  generated by `build_lineage.py` v1.1.0
...
| 25 | 2026-07-25 | v1.0 | Stopped-current FAR and complete-current NEAR coordinates | T4 | v1.0 |
| 26 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
