...
**Notes**: 83 files / 81 note-lineages  ·  **Runs**: 250  ·  generated by `build_lineage.py` v1.1.0
...
| 78 | 2026-07-31 | v1.0 | Terminal Gaussian jet threshold, floor-stable fixed-law action, and conditiona | T4 | v1.0 |
| 79 | 2026-07-31 | v1.0 | Post-recombined terminal coordinate, fixed-six-row conormal Gram envelopes, sh | T4 | v1.0 |
| 80 | 2026-07-31 | v1.0 | Variance-retained sequential atoms, self-to-sequential homotopy, and the direc | T4 | v1.0 |
| 81 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
