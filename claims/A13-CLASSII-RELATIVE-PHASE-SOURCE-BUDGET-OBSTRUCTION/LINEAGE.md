...
**Notes**: 43 files / 42 note-lineages  ·  **Runs**: 128  ·  generated by `build_lineage.py` v1.1.0
...
| 40 | 2026-07-27 | v1.0 | Root-local Gram secants and the nonduplicating feedback boundary | T4 | v1.0 |
| 41 | 2026-07-27 | v1.0 | Signed-first Cartan partition-refinement obstruction and rational ridge-defici | T4 | v1.0 |
| 42 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
