...
**Notes**: 69 files / 67 note-lineages  ·  **Runs**: 208  ·  generated by `build_lineage.py` v1.1.0
...
| 65 | 2026-07-30 | v1.0 | Six-row trace excess, direct source action, and the correlation boundary | T4 | v1.0 |
| 66 | 2026-07-30 | v1.0 | Stationary-polarized trace defect, replica closure, and the correlated | T4 | v1.0 |
| 67 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
