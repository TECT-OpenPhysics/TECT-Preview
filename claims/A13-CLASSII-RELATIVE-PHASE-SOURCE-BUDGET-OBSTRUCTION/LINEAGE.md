...
**Notes**: 75 files / 73 note-lineages  ·  **Runs**: 226  ·  generated by `build_lineage.py` v1.1.0
...
| 72 | 2026-07-31 | v1.0 | Post-recombined terminal coordinate, fixed-six-row conormal Gram envelopes, sh | T4 | v1.0 |
| 73 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
