...
**Notes**: 100 files / 98 note-lineages  ·  **Runs**: 302  ·  generated by `build_lineage.py` v1.1.0
...
| 97 | 2026-08-03 | v1.0 | Direct two-root endpoint Hessian and uniform local source gap | T4 | v1.0 |
| 98 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
