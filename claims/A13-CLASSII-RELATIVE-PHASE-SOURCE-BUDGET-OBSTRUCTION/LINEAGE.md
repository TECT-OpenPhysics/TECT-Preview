...
**Notes**: 56 files / 54 note-lineages  ·  **Runs**: 167  ·  generated by `build_lineage.py` v1.1.0
...
| 52 | 2026-07-28 | v1.0 | Scalar k:2k degenerate-face theorem, projective boundary, and mixed | T4 | v1.0 |
| 53 | 2026-07-28 | v1.0 | Square-first pair normalizer, signed score transfer, and filtration boundary | T4 | v1.0 |
| 54 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
