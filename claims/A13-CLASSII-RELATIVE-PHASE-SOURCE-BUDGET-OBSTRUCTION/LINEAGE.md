...
**Notes**: 103 files / 101 note-lineages  ·  **Runs**: 311  ·  generated by `build_lineage.py` v1.1.0
...
| 99 | 2026-08-03 | v1.0 | Direct two-root endpoint Hessian and uniform local source gap | T4 | v1.0 |
| 100 | 2026-08-03 | v1.0 | Weighted-Schur growing affine-root-union origin gap | T4 | v1.0 |
| 101 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
