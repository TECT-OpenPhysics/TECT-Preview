...
**Notes**: 39 files / 38 note-lineages  ·  **Runs**: 116  ·  generated by `build_lineage.py` v1.1.0
...
| 37 | 2026-07-27 | v1.0 | Root-local Gram secants and the nonduplicating feedback boundary | T4 | v1.0 |
| 38 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
