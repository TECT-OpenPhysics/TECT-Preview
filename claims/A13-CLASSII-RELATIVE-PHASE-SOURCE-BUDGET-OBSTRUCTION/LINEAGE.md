...
**Notes**: 58 files / 56 note-lineages  ·  **Runs**: 173  ·  generated by `build_lineage.py` v1.1.0
...
| 55 | 2026-07-28 | v1.0 | Square-first pair normalizer, signed score transfer, and filtration boundary | T4 | v1.0 |
| 56 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
