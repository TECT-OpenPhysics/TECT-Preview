...
**Notes**: 99 files / 97 note-lineages  ·  **Runs**: 299  ·  generated by `build_lineage.py` v1.1.0
...
| 94 | 2026-08-03 | v1.0 | Disjoint multipair factor-three resonance graph and origin-Hessian gap | T4 | v1.0 |
| 95 | 2026-08-03 | v1.0 | Production strict-past conditional Hessian and weighted-collar boundary | T4 | v1.0 |
| 96 | 2026-08-03 | v1.0 | Direct two-root endpoint Hessian and uniform local source gap | T4 | v1.0 |
| 97 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
