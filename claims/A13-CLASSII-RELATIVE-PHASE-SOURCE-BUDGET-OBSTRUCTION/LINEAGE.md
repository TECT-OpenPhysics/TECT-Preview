...
**Notes**: 97 files / 95 note-lineages  ·  **Runs**: 293  ·  generated by `build_lineage.py` v1.1.0
...
| 94 | 2026-08-03 | v1.0 | Direct two-root endpoint Hessian and uniform local source gap | T4 | v1.0 |
| 95 | ? | v1.1 | Class-II joint source-potential reduction and local Bellman no-go | T4 | v† → v1.1 |
