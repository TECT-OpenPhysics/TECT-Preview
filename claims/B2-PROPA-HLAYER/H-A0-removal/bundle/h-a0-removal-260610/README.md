# Reproduction bundle -- B2-PROPA-HLAYER / H-A0-removal

Self-contained referee reproduction bundle (TECT verification-first repository).
Built 20260611T031908Z with Python 3.10.12, numpy 2.2.6.
...
## Contents
- the referee note (proof, self-contained): `claims/B2-PROPA-HLAYER/H-A0-removal/notes/ha0-removal-pathway-260606-260606-v2.1.tex.txt`
  (+ its `.pdf`)
...
pip install -r requirements.txt        # numpy only
  python codes/vacuum/ha0_sign_decomposition.py
```
...
## Expected (must match)
  ha0_sign_decomposition: exit 0, `claims 23/23 PASS`

## Integrity
Bundle content digest (sha256 over `<sha256>  <path>` lines):
`34b9699fd470ae0d9b83875628a65f4e7dda3a0325ed5128e5e791aa0f1df4de`
