# Reproduction bundle -- B2-PROPA-HLAYER / Prop-A

Self-contained referee reproduction bundle (TECT verification-first repository).
Built 20260611T033450Z with Python 3.12.10, numpy 2.2.6.
...
## Contents
- the referee note (proof, self-contained): `claims/B2-PROPA-HLAYER/Prop-A/notes/hlayer-closure-final-consolidation-260610-v1.0.tex.txt`
  (+ its `.pdf`)
...
`1974d37a9ef49af8f91ee615cd87a8897c517c435a78ce8cbda7b02f64d60066`
