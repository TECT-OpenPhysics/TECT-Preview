# Reproduction bundle -- Prop-A class-wide H-LAYER closure on A_adm (T'<=13), main-line supporting (DRAFT)

Self-contained referee reproduction bundle (TECT verification-first repository).
Built 20260611T063820Z with Python 3.10.12, numpy 2.2.6.
...
## Contents
- the referee note (proof, self-contained): `claims/B2-PROPA-HLAYER/Prop-A/notes/prop-a-referee-package-260610-260611-v1.1.tex.txt`
  (+ its `.pdf`)
...
`9ee560e1a9c19d9d03abee5974fad57873d365200ef8ab601c1752961e33007c`
