...
The default invocation is also read-only. It executes the canonical finite
...
the complete new payload with the separate current replay record:
    ...
    claims/C6-SPACETIME-SIGNATURE/runs/2026-09-07-q3lock-paper-readonly-replay/result.json
...
After a reviewed documentation change, use an absent output path explicitly:

    & E:/Dev/TECT.venv/Scripts/python.exe -X utf8 verification/scripts/q3lock_paper_replay.py --write-new --output internal/replay-candidate/result.json
