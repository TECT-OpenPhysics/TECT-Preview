...
| `res-endpoint-admissible-pin` | v1.0 | T6* | Over the admissible crystallographic-shell class (single shells + cumulative balls + all <=4-shell unions, N<=41; 130 configs): EXACT worst K_floor =… | EXACT (combinatorial K_floor, T') + EXECUTED … | Close the chi(P)<~T' carrier-richness link (B5 operator-decision) to make the RES-5 endpo… |
