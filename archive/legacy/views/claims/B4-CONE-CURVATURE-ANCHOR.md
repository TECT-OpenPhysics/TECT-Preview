# B4-CONE-CURVATURE-ANCHOR legacy research view

<!-- AUTO-GENERATED. Current claim cards remain authoritative. -->

Current claim: **BCC single-mode-cone uniqueness + positive local curvature anchor (metastable branch)** | tier `T5` | lifecycle `ACTIVE`.
