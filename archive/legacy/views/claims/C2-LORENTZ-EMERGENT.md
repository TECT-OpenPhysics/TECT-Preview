# C2-LORENTZ-EMERGENT legacy research view

<!-- AUTO-GENERATED. Current claim cards remain authoritative. -->

Current claim: **Emergent Lorentz isotropy via 1-loop interval enclosure** | tier `T6` | lifecycle `ACTIVE`.

Linked reviewed records: **1**.
