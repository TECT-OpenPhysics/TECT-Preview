#!/usr/bin/env python3
"""Primary source-Gibbs cancellation stress for EXP-001213 / R-371."""
...
def main() -> int:
    ...
    print(f"PRIMARY KUBO-MORI GIBBS-CANCELLATION PASS {payload['assertion_count']}/{payload['assertion_count']} contexts={payload['derived']['context_count']} max_weighted={payload['derived']['maximum_weighted_fractional_norm']:.6f}")
    return 0
