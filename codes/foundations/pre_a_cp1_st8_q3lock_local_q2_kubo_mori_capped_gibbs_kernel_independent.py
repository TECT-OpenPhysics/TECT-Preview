#!/usr/bin/env python3
"""Non-importing independent capped-Gibbs-kernel stress for EXP-001215 / R-373."""
...
def main() -> int:
    ...
    print(f"INDEPENDENT CAPPED-GIBBS-KERNEL PASS {payload['assertion_count']}/{payload['assertion_count']} contexts={payload['derived']['context_count']} shell={payload['derived']['maximum_capped_shell']:.6f}")
    return 0
