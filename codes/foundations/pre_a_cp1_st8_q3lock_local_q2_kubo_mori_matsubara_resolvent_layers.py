#!/usr/bin/env python3
"""Primary finite odd-Matsubara resolvent-layer audit for EXP-001216 / R-374."""
...
def main() -> int:
    ...
    print(f"PRIMARY MATSUBARA-RESOLVENT-LAYERS PASS {payload['assertion_count']}/{payload['assertion_count']} contexts={payload['derived']['context_count']} tail={payload['derived']['maximum_matsubara_tail_bound']:.6e}")
    return 0
