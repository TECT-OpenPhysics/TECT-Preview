...
DEFAULT_PRIMARY = CLAIM / "runs" / "2026-07-19-t6-conditional-candidate-primary" / "result.json"
DEFAULT_OUTPUT = CLAIM / "runs" / "2026-07-19-t6-conditional-candidate-independent" / "result.json"
...
def main() -> int:
    ...
    confirmed_t6_reproduction_ok = published_state and reproduction.get("status") == "AVAILABLE"
    check(
    ...
    output = {
        ...
        "promotion_boundary": "Independent preflight is necessary but not operator confirmation or PUBLISHED authorization.",
    }
