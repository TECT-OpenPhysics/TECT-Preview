...
DEFAULT_OUTPUT = CLAIM / "runs" / "2026-07-19-t6-conditional-candidate-primary" / "result.json"
...
def main() -> int:
    ...
    check(
        ...
        manifest.get("schema") == "tect/a5-t6-conditional-composition/1.0"
        and manifest.get("claim_id") == __claims__[0]
        and manifest.get("candidate_tier") == "T6"
        and manifest.get("publication_state") == "REFEREE-CANDIDATE-OPERATOR-CONFIRMATION-REQUIRED",
        {
    ...
    output = {
        ...
        "promotion_boundary": "Referee candidate only until exact-package operator confirmation; no PUBLISHED T6 bundle is authorized by this audit.",
