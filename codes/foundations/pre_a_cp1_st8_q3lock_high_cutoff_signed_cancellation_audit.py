...
def run() -> dict[str, Any]:
    ...
    check("graph volumes", volumes == [2] and all(base.q3.graph_edges(volume) for volume in volumes), volumes, "registered fixed Q3 graph volume", "fixture")
...
def main() -> int:
    ...
    print(f"PRIMARY HIGH-CUTOFF-SIGNED-CANCELLATION PASS {payload['passed']}/{payload['assertion_count']} rows={payload['derived']['row_count']}")
    return 0
