...
def build_payload() -> dict[str, Any]:
    ...
    related_pairs = sorted((item.get("id"), item.get("relation")) for item in exploration.get("related", []))
    audit.check("exploration related parents", PARENT_EXPLORATIONS <= set(related_pairs), related_pairs, sorted(PARENT_EXPLORATIONS), "records")
