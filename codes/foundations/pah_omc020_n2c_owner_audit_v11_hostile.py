...
DEFAULT_OUTPUT = ROOT / (
    ...
    "2026-09-08-pah-omc020-n2c-owner-audit-v1.1/hostile.json"
)
...
def compute() -> dict:
    ...
    intake = json.loads((ROOT / "strategy/pa-hyp/PAH-OMC-020-N2a-owner-packet-intake-v1.1.json").read_text(encoding="utf-8"))
