#!/usr/bin/env python3
"""Primary source-energy-window stress for EXP-001212 / R-370."""
...
def main() -> int:
    ...
    print(f"PRIMARY KUBO-MORI ENERGY-WINDOW PASS {payload['assertion_count']}/{payload['assertion_count']} contexts={payload['derived']['context_count']} max_weighted={payload['derived']['maximum_weighted_fractional_norm']:.6f} max_high_gap_fraction={payload['derived']['maximum_high_gap_fraction']:.6f}")
    return 0
