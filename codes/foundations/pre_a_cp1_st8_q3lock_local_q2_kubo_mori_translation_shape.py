#!/usr/bin/env python3
"""Primary source-translation and shape stress for EXP-001211 / R-369."""
...
def main() -> int:
    ...
    print(f"PRIMARY KUBO-MORI TRANSLATION-SHAPE PASS {payload['assertion_count']}/{payload['assertion_count']} contexts={payload['derived']['context_count']} max_weighted={payload['derived']['maximum_weighted_fractional_norm']:.6f}")
    return 0
