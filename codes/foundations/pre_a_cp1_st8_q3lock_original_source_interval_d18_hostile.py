#!/usr/bin/env python3
"""Hostile mutation firewall for the R-436 finite d=18 certificate."""
...
DEFAULT_OUTPUT = REPO / "claims/C6-SPACETIME-SIGNATURE/runs/2026-08-30-hostile-original_source_interval_d18/hostile.json"
...
def run(output: Path = DEFAULT_OUTPUT) -> dict[str, Any]:
    ...
    payload = {
        "schema": "tect/pre-a-r436-hostile/1.0",
    ...
    print(f"R-436 HOSTILE {payload['verdict']} {len(checks)}/{len(checks)}", flush=True)
    return payload
...
def main() -> int:
    ...
    if args.self_test:
        ...
        print("R-436 HOSTILE SELFTEST: PASS", flush=True)
    return 0
