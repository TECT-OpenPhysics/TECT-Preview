...
Working proof notes (the successor of legacy Math notes) live with their claim:
`claims/<ID>/notes/<claimID>-<slug>-v<major>.<minor>.md` — versioned re-issue,
all versions kept (`governance/naming-and-versioning.md` §3).
