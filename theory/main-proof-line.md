...
| 3 | additive-energy / DR-2 | `claims/B5-BEYOND-LAYER-BOUND/DR-2` | Lemma 1: the sum-circle / lattice additive-energy bound (R-025/026) | **DRAFT ACCEPTED** (v1.2, 2026-06-12; T7-candidate on the lattice class mod Lemma NT; operator clean-run 6/7 PASS, lattice_divisor v1.0.0 timeout repaired by v2.0.0 runtime patch (2.5 s, 7/7, equivalence + regression oracle); published-bundle HELD pending operator re-run of v2.0.0 + Lemma NT pin) |
