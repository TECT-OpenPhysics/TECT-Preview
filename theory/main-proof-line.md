...
queue: all five main-line packages are PUBLISHED and review-complete; the parent MAIN-LINE SYNTHESIS capstone is WRITTEN (`theory/main-line-synthesis-260612-v1.0` -- dependency DAG, per-edge tier/scope, composite-grade accounting, track separation; operator review pending). Remaining per the synthesis Sec.5: per-claim SYNTHESIS layers (T-013 continuation), T-030 arbitrary-Q DR-2 (frontier, NOT load-bearing for C_full), T-031 STEP-5B exhaustiveness decision layer (+ T-004 R-U6-1).
