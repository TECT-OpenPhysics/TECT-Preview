...
| 3 | additive-energy / DR-2 | `claims/B5-BEYOND-LAYER-BOUND/DR-2` | Lemma 1: the sum-circle / lattice additive-energy bound (R-025/026) | **PUBLISHED AS T7-CANDIDATE MOD LEMMA NT** (v1.3) -- bundle `B5-BEYOND-LAYER-BOUND/bundle/DR2-Lattice-T7Candidate-260612` (7/7 scripts, 33/33 asserts, operator clean-run CONFIRMED 2026-06-12); final T7 promotion HELD on the Lemma NT pin ONLY -> pin DELIVERED 2026-06-12 (in-bundle proof note `dr2-lemma-nt-inbundle-260612-v1.0` + exhaustive script `dr2_lemma_nt_exhaustive.py` 5/5, 2,644,976 sums; package v1.4, 8-script manifest 38/38) awaiting operator review; lattice shells only, arbitrary-Q OPEN |
...
queue: all five main-line packages are now PUBLISHED (Reading-H-cFull-T7, Prop-A-T6, STEP-5B-Rectangle-T6, SC-SCOPE-T5, DR2-Lattice-T7Candidate mod Lemma NT). Remaining on DR-2: the Lemma NT pin only (-> final T7 promotion). Per policy sec.15 the claim-level SYNTHESIS capstone (T-013) is next. Full STEP-5B budget comparison + admissibility gates remain separately tracked.
