...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-FULL-FRAME-POSTERIOR-COVARIANCE-BRACKET)_
  - R-102 proves the regular annular mutually orthogonal strict-past no-revisit rational-current closure. After refunding the duplicate R-076 base-cubic and separate R-086 T_G<= current allocations, finite j<k Fubini plus whole-product F_(k-1) conditioning turns the future-feedback residual into predictable last-insertion columns. The derivative branch has slack 1/6; the high-prefix coefficient branch has X^(9/14)(1+Y)^(2/7), shell decay 2^(-k/14), limiting slack 1/14, and moment 14. EXP-000257 retains the fixed-low derivative branch `X^(1/7)(1+Y)^(19/42)`, slack 17/42, and moment 42/17. Primary 106/106, independent 79/79, integrated 339/339, and aggregate 524/524 are the pinned contract. The bound is uniform in cutoff and deterministic PSD target and future heat, leaves the terminal square unspent, and closes regular K_R. Next reassemble complete regular H_N and REG from the existing raw-Wick, fixed-low, linear, heat, trace, payment, q/r, R-100 residual, and R-063 forest owners exactly once. Progressive/revisit H_A, OVERLAP_src, Nelson, removals, measure construction, and Sector A remain open.
