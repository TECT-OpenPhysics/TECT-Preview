...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - R-466 / EXP-001341 is a release-gated T0 finite conditional Gibbs-mass lower-bound interface derived from the unchanged R-464/R-465 comparisons. For a later owner-supplied measurable box tube B_N=c_N+[-delta,delta]^d with delta>0 and energy ceiling E_tube, it proves mu_N(B_N)>=vol(B_N)*exp(-beta*E_tube)/Z_upper_N and records the logarithmic geometric/Boltzmann/normalization budget. Owner-neutral fixtures delta=1/16 and E_tube=1 pass primary 124/124, independent 122/122, hostile 8/8, integrated 53/53, and Lean R466; the coarse log lower bound decreases with cutoff. This supplies no source-owned branch, actual A1 ceiling, entropy/Jacobian compensator, cutoff-uniformity, tightness, continuum, physical, QFT, Yang--Mills, or mass-gap conclusion. Existing T-054 forward method, T-059/T-061 inverse locks, owner order, and promotion firewalls remain unchanged. Next: obtain and hash-pin the source-owned active embedding/tube/ceiling, instantiate R-466 with R-463 metric, and test branch-relative entropy rather than repeating the full-dimensional proxy.
...
- **T-061** Dynamic-owner and observation-map identifiability intake  _(owner: Codex; gate: PA-INVERSE-OBSERVATION-TARGET-MAP-HOLDOUT-FREEZE)_
  - First post-P0-R paired packet under T-054/T-059. R-446 / EXP-001298 validates the frozen OBS-LC-CAL-001 S3 d=3..9 row interface with independent and hostile checks. R-447 / EXP-001299 adds an exact, unweighted HOLD-LC-001 set-valued delay envelope with primary 25/25, independent 13/13, hostile 12/12, integrated 9/9 and Lean R447 PASS. EXP-001300 records official public-product discovery; EXP-001301 freezes nine exact event-product bytes with SHA-256 values in a gitignored cache; EXP-001302 freezes a candidate-neutral Delta_t_det estimator contract with physical/proof owner split and four-stage admission boundaries. EXP-001303 independently rechecks the nine bytes, extracts GBM TT/MJDREF/event-table metadata and GW sample/GPS/duration headers, and rejects a mutated hash. EXP-001304 quote-aware parses the two GBM response headers for creator/DRM/channel-energy provenance and confirms the selected LIGO low-spin posterior schema has no merger-time coordinate. EXP-001305 freezes and independently audits one event-day Fermi position/attitude owner candidate plus N0/B0 spectral-history owner candidates, with TT-second coverage and required FITS schemas. EXP-001306 freezes and independently audits N0/B0 event-trigger rsp2 response histories, with one EBOUNDS and eight numbered SPECRESP MATRIX segments per detector and TT-second trigger-window coverage; matrix values, validity/interpolation, detector-to-geocenter conversion, shared covariance, timing likelihood, nuisance law, complete map, scorer and prospective lock remain missing. EXP-001307 converts official Fermi role semantics plus the exact pinned products into an additive response-owner request contract; response values, validity/interpolation, geocenter conversion, uncertainty, likelihood/covariance, nuisance law and scoring remain unadmitted. EXP-001308 enumerates official nearest/interpolate/weighted response and MET/TT/GPS/UTC/UT1 implementation choices, making package defaults, boundary handling, Earth orientation and propagation uncertainty explicit owner fields; no response values or scoring is admitted. Candidate scoring remains stopped. Existing T-054 forward and T-059 inverse methods are unchanged; continue owner intake and independent F_reg reproduction only after all fields are frozen. EXP-001309 crosswalks the primary LIGO publication timing summary (0.310 +/- 0.048 s pulse-fit onset, -3.176 ms Fermi-minus-geocenter anchor, +1.74 +/- 0.05 s corrected delay and the standard window) as retrospective provenance only. The inspected source scope does not yet supply a reproducible pulse estimator, detector-to-geocenter algorithm, covariance or source-owner uncertainty packet; keep response values, scoring and prospective credit locked. Existing T-054/T-059 methods remain unchanged. EXP-001310 records the official P1900186 Lambda signal-versus-background statistic and R association ranking with empirical O1/O2 background calibration as a partial finite statistical-owner candidate. It is not a continuous Delta_t_det likelihood and does not fill detector-to-geocenter propagation, response validity, covariance, intrinsic-lag nuisance or prospective fields; existing T-054/T-059 methods remain unchanged. EXP-001311 adds the primary Stachie et al. implementation: version-pinned finite Lambda with competing hypotheses, Q_L/Q_G factors, triangular time-overlap prior, sky-overlap integral and time-shifted FAR calibration. This advances only a retrospective finite statistical-owner candidate; continuous timing, response, propagation, covariance, intrinsic-lag and prospective fields remain unadmitted. Existing T-054/T-059 methods and owner order remain unchanged. EXP-001312 pins the public USRA-STI/gamma-ray-targeted-search commit 1bc1e913f97fd7195a7e297f8d6032a5c7758894 and finite GBM Likelihood/response/search/prior paths. This is a code-level calibration owner candidate with a synthetic-first reproduction packet; event/template bytes, dependency lock, Stachie joint-ranking linkage, detector-to-geocenter uncertainty, covariance, nuisance and prospective fields remain unadmitted. Existing T-054/T-059 methods and owner order remain unchanged. EXP-001313 completes the synthetic GTS code-semantics checkpoint: primary and independent scalar finite LLR arrays and marginal values agree within 4.547e-13, a hostile +7 count mutation changes the marginal by 45.681982, and the dependency boundary is explicit. This is T0 calibration/provenance only; external environment, event/template bytes, continuous timing, detector-to-geocenter, covariance, intrinsic-lag, prospective and physical-owner fields remain unadmitted. Existing T-054/T-059 methods and owner order remain unchanged; next action is to hash-pin the external environment and event inputs before any event execution. EXP-001314 verifies the 14 hash-pinned event/owner products byte-for-byte (14/14) and confirms the GTS source commit, while the CPython 3.12.9 audit interpreter has only NumPy of six required import modules (1/6). This is a T0 input/runtime readiness boundary with matrix values unread and event execution false, not a statistical or physical result. Existing T-054/T-059 methods and owner order remain unchanged; next action is to obtain an exact-version external GTS environment before any event-level run. EXP-001315 executes the hash-pinned public likelihood.py calculate path on the synthetic fixture: source hash, AST utils isolation, direct finite execution, independent transcription, hostile count mutation and prethreshold branch all PASS. This is T0 code-level calibration/provenance only; the full GTS/GDT runtime, event bytes, response values, timing, covariance, prospective scoring and physical fields remain unadmitted. T-054 forward and T-059 inverse methods remain unchanged. Next action: obtain a complete supported-platform environment lock, then run the event-free response-index/likelihood packet. EXP-001316 records the exact astro-gdt healpy~=1.18.0 contract boundary: PyPI has no Windows wheel for healpy 1.18.0 and conda-forge has no win-64 1.18.0 artifact. This is a T0 package/platform execution boundary, not a scientific no-go; no healpy minor substitution, event score, response value or physical promotion is admitted. Existing T-054/T-059 methods, owner order and promotion firewalls remain unchanged. Next action: obtain a supported-platform lock or fully pinned source-build lock, then rerun readiness.
  - _updated 2026-08-30_
...
- **T-056** Literature-first proof gate and legacy-evidence audit rollout  _(owner: Codex; gate: LITERATURE-FIRST-APPLICABILITY-AUDIT)_
  - EXP-000863 / R-170 v1.0 completes exactly the initial four-record rollout. B1 APPLIES only to the registered C_full candidate-versus-G_* ordering; C4 and C5 are NOT-YET-ASSESSED; the present C6 BCC-premised route DOES-NOT-APPLY while non-BCC alternatives remain NOT-YET-ASSESSED. LITERATURE-FIRST-APPLICABILITY-AUDIT is CLOSED@INITIAL-FOUR-RECORDS, but the policy remains binding and T-057 and all physical residual routes remain open. No tier, lifecycle, negative, Sector-A, or Pre-A change follows.
  - _updated 2026-08-14_
