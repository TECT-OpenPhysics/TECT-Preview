...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 remains the frozen exact shifted-state boundary for one finite acyclic pure-dyadic deterministic chain. EXP-000717 shows that path-weighted A1 synthesis removes the crude full-lattice divergence for a finite disjoint collection of mode-distinct deterministic dyadic chains, but this exploration-level extension is not the general R-104/R-125 forest and does not change T-050 status. EXP-000718 records the decisive method boundary: bounded amplitude, covariance, fixed moments, and path weights cannot control arbitrary legal nonlinear forests because the R-125 chain rule contains Dh and D2h, while the registered bounded tanh feedback has uniformly bounded amplitude but divergent score or inverse-Jacobian energy. T-050 stays parked at actual overlapping or revisit forests, random or nonlinear realised-past coefficients, and the pathwise complete conditional Hessian. Reopen direct A13 only with one of three new inputs: a derivative or score production collar, a Markov or contractive production theorem, or a direct complete R-125 variance-minus-forest signed-owner estimate. The main lane remains truth-first T-054; T-052 stays closed for pinned M1 and T-053 is reserved for surviving candidates.
  - _updated 2026-08-03_
