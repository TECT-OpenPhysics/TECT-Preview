...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - Published EXP-000758--EXP-000790 preserve the evidence-first tournament and the exact CP1/ST8 mathematics without selecting a winner. EXP-000790 resumes the requested ordered ST8/Q3LOCK lane from EXP-000789: each positive-lambda DLR sign phase now separately satisfies the complete periodic P1--P4/P-star interface on one declared rational-character sharp-time C-star algebra and reconstructs an abstract beta-KMS system, but the post-hoc direct sum is not a common Hamiltonian-derived alpha and current bounded-perturbation dynamics theorems do not directly cover the exact quartic onsite plus unbounded bilinear coupling. EXP-000780/789 compose to e(h)-e(0)<=-|h|sqrt(rho_*)/8 and parity-related locally normal time-zero tangent candidates; algebraic ground promotion awaits common-core dynamics. The exact state-vector GNS Poincare falsifier is Delta_omega^P<=hbar^2|B|/[2 chi Var(S_B)], while ground-vector simplicity and a sector gap remain open. Aut(Q3) quartic closure has ranks 2,4,9,19,19 and the invariant quadratic algebra has dimension four, closing the counterterm-basis classification but not regulator removal. The finite-volume finite-regulator same-H reference contract rules out another equilibrium phase as a strict physical-empty comparator; a preregistered preparation/constrained branch and positive specific gap remain mandatory. The primary cross-candidate gate remains PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE. The next parallel ST8 gate is PA-CP1-ST8-Q3LOCK-RESOLVENT-ALGEBRA-EXACT-POLYNOMIAL-COMMON-ALPHA-CLOSURE, followed by common-alpha KMS identification, algebraic ground selection, GNS Poincare testing, enlarged-counterterm continuum, and physical-empty comparison. Keep C6, CP1, Pre-A and physical Sector-A closure open.
