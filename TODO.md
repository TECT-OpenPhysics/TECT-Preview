...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-128 proves the fixed-chart differentiated R-104 owner pullback and bounded-linear refinement conjugacy, separates control from Malliavin source derivatives with bounded Jacobian and connection fixtures, and repairs the complete R-125 covariance-normal force to (g_V-g_T)/2 with sextic/source-cost derivatives declared. It records common-terminal, one-sided reverse-adjoint, full-cross-factor, zero-diagonal-margin, and source-square double-spend firewalls. The next theorem is A13-CLASSII-PRODUCTION-AUGMENTED-SOURCE-HESSIAN-UNIFORM-SCHUR-GAP: identify two-sided corrected covariance-normal root/shell blocks, prove H_V/H_T constants in one A_eff=2T convention, include every balanced, rational, Cartan/forest, diagonal, low, absolute-anchor, and common-terminal owner once, and establish a uniform positive full-M2/Douglas margin. Both A13 gates, OVERLAP_src, Nelson, removals, interacting measure, and Sector A remain open.
