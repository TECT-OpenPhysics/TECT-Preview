...
- **T-061** Dynamic-owner and observation-map identifiability intake  _(owner: Codex; gate: PA-INVERSE-OBSERVATION-TARGET-MAP-HOLDOUT-FREEZE)_
  - First post-P0-R paired packet under T-054/T-059. R-446 / EXP-001298 validates the frozen OBS-LC-CAL-001 S3 d=3..9 row interface with independent and hostile checks. R-447 / EXP-001299 adds an exact, unweighted HOLD-LC-001 set-valued delay envelope with primary 25/25, independent 13/13, hostile 12/12, integrated 9/9 and Lean R447 PASS. EXP-001300 records official public-product discovery; EXP-001301 freezes nine exact event-product bytes with SHA-256 values in a gitignored cache; EXP-001302 freezes a candidate-neutral Delta_t_det estimator contract with physical/proof owner split and four-stage admission boundaries. EXP-001303 independently rechecks the nine bytes, extracts GBM TT/MJDREF/event-table metadata and GW sample/GPS/duration headers, and rejects a mutated parent hash. EXP-001304 quote-aware parses the two GBM response headers for creator/DRM/channel-energy provenance and confirms the selected LIGO low-spin posterior schema has no merger-time coordinate. EXP-001305 freezes and independently audits one event-day Fermi position/attitude owner candidate plus N0/B0 spectral-history owner candidates, with TT-second coverage and required FITS schemas. EXP-001306 freezes and independently audits N0/B0 event-trigger rsp2 response histories, with one EBOUNDS and eight numbered SPECRESP MATRIX segments per detector and TT-second trigger-window coverage; matrix values, validity/interpolation, detector-to-geocenter conversion, shared covariance, timing likelihood, nuisance law, complete map, scorer and prospective lock remain missing. EXP-001307 converts official Fermi role semantics plus the exact pinned products into an additive response-owner request contract; response values, validity/interpolation, geocenter conversion, uncertainty, likelihood/covariance, nuisance law and scoring remain unadmitted. EXP-001308 enumerates official nearest/interpolate/weighted response and MET/TT/GPS/UTC/UT1 implementation choices, making package defaults, boundary handling, Earth orientation and propagation uncertainty explicit owner fields; no response values or scoring is admitted. Candidate scoring remains stopped. Existing T-054 forward and T-059 inverse methods are unchanged; continue owner intake and independent F_reg reproduction only after all fields are frozen. EXP-001309 crosswalks the primary LIGO publication timing summary as retrospective provenance only. EXP-001310 records the official P1900186 Lambda statistic as a partial finite statistical-owner candidate. EXP-001311 adds the primary Stachie finite Lambda implementation as retrospective statistical-owner evidence. EXP-001312 pins the public USRA-STI gamma-ray-targeted-search commit and finite GBM likelihood paths as code-level calibration candidate. EXP-001313 completes the synthetic GTS code-semantics checkpoint. EXP-001314 verifies the 14 hash-pinned event/owner products and records the incomplete runtime boundary. EXP-001315 executes the hash-pinned public likelihood path on a synthetic fixture. EXP-001316 records the exact astro-gdt healpy package/platform boundary. EXP-001334 records a hash-pinned healpy source-build attempt blocked before wheel creation by missing pkg-config/cfitsio metadata. R-468 / EXP-001343 adds a finite binary-table index for the two rsp2 products: primary 35 assertions, independent core 4 assertions, hostile 10/10, integrated 10/10 and Lean R468 pass; 128 EBOUNDS rows and eight ordered 140-row response segments per detector are verified, three covering/nearest/center-bracket alternatives remain retained with NONE_SELECTED, and matrix coefficients, validity/interpolation, detector-to-geocenter conversion, timing uncertainty, likelihood, covariance, nuisance, complete map, scoring and prospective credit remain unadmitted. Existing T-054/T-059/T-061 methods, owner order and promotion firewalls remain unchanged. Next: request and hash-pin the owner validity/interpolation and timing-uncertainty rules; keep all response alternatives and scoring locked.
  - _updated 2026-08-31_
