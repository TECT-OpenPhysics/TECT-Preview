...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000713 establish the LT3/ST8 finite-local branch; EXP-000714--EXP-000716 retain CP1a as a fitted comparator; EXP-000719 registers Q3LOCK; EXP-000724 and EXP-000725 register and repair the finite-C1 strict-cone no-go. EXP-000728 now splits the controlled-continuum checkpoint into PA-CP1-CL8-GOURSAT-v0 and PA-CP1-CL8-SEMIDISCRETE-CAUCHY-OA2-v0. The first proves, on an inserted fixed 1+1 Lorentzian background and the pinned one-eighth ledger, gated transverse-zero eight-species classical Goursat reconstruction, exact continuum energy balance, inherited-sign variational symplectic flux, and only a supplied classical field-value measure pushforward. The second proves fixed-periodic-domain, fixed-time O(a^2) convergence for separately supplied smooth Cauchy data in weighted discrete H1_a times L2_a, exact finite Hamiltonian and variational symplectic conservation, and only an aggregate O(a^2) bound on regions where the continuum solution vanishes. Goursat primary 53, independent 52, integrated 75 and semidiscrete primary 38, independent 29, integrated 80 checks pass, 327 combined. They are not composed: PA-CP1-CL8-BOUNDARY-TO-LATTICE-COMPOSITION remains open, including phase-slice regularity, compatible same-domain sampling and reconstruction, energy, symplectic and supplied-measure control, and a common selected state. Exact finite-a support remains false; registered variational witness tails remain nonzero, while the convergence theorem neither proves nor requires a nonzero tail for every datum. Next close or refute the composition gate before quantum promotion. Keep block-origin restoration, fine translation, full 3+1 dependence, quantum continuum and state selection, physical empty space and the below-empty-space sign, cooling, gravity, CP1 and Pre-A open.
...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 remains the frozen deterministic shifted-state boundary. EXP-000720--EXP-000723 restore the complete derivative-free R-141 owner and reject first-derivative, control-energy, and isolated H22 shortcuts. EXP-000726/727 prove only that the actual relative endpoint density is not log-concave and retire pointwise Foellmer contraction and cutoff-uniform unweighted sup-Jacobian collars. EXP-000729 audits the three surviving directions and finds no cheap shortcut: the direct legal chart still needs compact-annulus certification plus a cutoff-uniform lift; the unweighted integrated route is a new endpoint Fisher theorem; and the global supermartingale route is the existing R-108 complete-owner Carleson target, with finite-bank local reserves already excluded. T-050 stays parked. Reopen only with a complete fresh-averaged production quotient including every owner once, a separately proved cutoff-uniform integrated endpoint estimate, or a new scheme-independent global-action argument. The main lane is truth-first T-054; T-053 is reserved for candidates that survive the Pre-A tournament.
  - _updated 2026-08-03_
