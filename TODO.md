...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000725 retain the LT3/ST8/Q3LOCK finite-local branch, CP1a comparator, and strict-cone boundaries. EXP-000728--EXP-000731 separate and compose the CL8 Goursat and semidiscrete classical routes while formally refuting generic unchanged periodic wrapping. EXP-000734/735 close the finite-triangle global Goursat gate in fixed-background classical scope and repair the cumulative high-regularity recursion; corrected checks are 63 primary, 60 independent and 148 integrated. EXP-000736 advances PA-CP1-CL8-INVARIANCE-SELECTION-FORK-v0. Every fixed periodic CL8 regulator has a global Liouville-preserving flow and invariant Gibbs laws for beta>0, with exact momentum variance 8chi/(beta*a), plus normalized F(H_a) and compact energy-sublevel controls. For r<0, mu_zero=delta_(0,0) and mu_ordered=(delta_(+v,0)+delta_(-v,0))/2 are distinct compactly supported measures on smooth direct-seam phases, invariant under the continuum and every centered lattice flow, preserving translation, Q3, global Z2, momentum-reversal and time-reversal symmetries, and composing with exact zero error. Their raw energies are 0 and -L*r^2/(4g). NG-2026-08-03-PRE-A-CP1-CL8-INVARIANCE-ONLY-PREFERRED-STATE therefore refutes unique classical preference from invariance, these symmetries, smooth phase support, seams and regulator compatibility alone. Primary 59, independent 66 and integrated 81 checks pass, 206 combined, with stored freshness, corrected sign/hardcode audits and three independent referee passes. The parent preferred-state gate remains open. Next construct PA-CP1-CL8-FINITE-REGULATOR-QUANTUM-STATE with explicit p=(a/8)Pi CCR and hbar, then attack the quantum boundary-algebra intertwiner, continuum/Hadamard limit, and common-parent physical state/reference. Keep beta or energy selection, physical classical state, quantum boundary state, physical vacuum and below-empty-space comparison, finite-a exact cone, full 3+1 dynamics, gravity, cooling, C6 advancement, CP1 and Pre-A open. EXP-000737 adds a theorem-neutral alternate proof of the same finite-triangle C1 existence conclusion: for R_bar>S_tau the componentwise-clipped force is globally Lipschitz, its whole-triangle Volterra map contracts in the Bielecki norm at factor 1/2 for beta^2=ell_Rbar/(2chi), and first contact contradicts S_tau<R_bar. It removes dependence on shell geometry only, shares the energy-amplitude input, and changes no theorem, result, gate, high-regularity authority, seam, or state boundary. The duplicate standalone package was rejected rather than double-counted. Updated global-Goursat checks are 68 primary, 65 independent and 159 PDF-aware integrated, 292 combined; all six A4 PDF pages passed manual visual review. Keep T-050 parked until a registered reopen condition appears. SUPERSEDED NEXT STEP: EXP-000738 now advances PA-CP1-CL8-FINITE-QUANTUM-STATE-BOUNDARY-FORK-v0 in fixed-regulator T0 scope. With declared hbar and p=(a/8)Pi, the coercive interacting CL8 Schrodinger operator on the infinite-dimensional Hilbert space L2(R^(8M)) has a Friedrichs self-adjoint realization, compact resolvent, one simple ground with a strictly positive smooth wavefunction, faithful Gibbs normal states for every beta>0, and an explicit trace-norm beta-to-infinity bound. The ground projector and every finite-beta Gibbs density are distinct stationary normal states on B(L2) preserving periodic CL8 node/coarse translations, Q3, and global Z2, so NG-2026-08-03-PRE-A-CP1-CL8-STATIONARITY-ONLY-QUANTUM-STATE refutes unique preference from stationarity and those symmetries alone. Primary 79, independent 90, and integrated 105 checks pass, 274 combined, including a non-diagonal independent spectral fixture, stored freshness, parent hashes, energy-reference and scope audits. The interacting dynamics is not proved to preserve the regular Weyl C-star algebra. The ground criterion and hbar are inputs; no physical empty-space or no-condensate reference exists on the same regulator, so absolute and below-empty-space signs remain open. The active next gate is PA-CP1-CL8-QUANTUM-BOUNDARY-ALGEBRA-INTERTWINER, followed by continuum/Hadamard and physical state/reference selection. Keep C0/N1-N5, phase transition, full 3+1 dynamics, gravity, cooling, C6 advancement, CP1, and Pre-A open. EXP-000741, corrected by EXP-000742 after hostile review, advances PA-CP1-CL8-QUANTUM-BOUNDARY-ALGEBRA-INTERTWINER-ROUTE-SPLIT-v0 at claim-nonbearing T0 scope. With canonical coefficient momentum Pi=chi*xi_t, the ordered collective 1, cos(4x), sin(4x) characteristic image has exact frequencies 3,5,5 and a symplectic transfer with blocks [[cos,sin/(chi*omega)],[-chi*omega*sin,cos]]. For every even M>=4, roots-of-unity quadrature gives an exact collective band-sampling Weyl monomorphism, and each registered interacting fixed-regulator ground or Gibbs normal state pulls back to an exact regular state on this restricted boundary algebra. NG-2026-08-04-PRE-A-CP1-CL8-OA2-SAMPLING-EXACT-WEYL refutes unrestricted point-sampling CCR by a kernel commutator -1 versus +1; NG-2026-08-04-PRE-A-CP1-CL8-DIRECT-NONLINEAR-WEYL-RELABEL uses the actual ordered second variation with endpoint slope -3g*v0*tau/chi; NG-2026-08-04-PRE-A-CP1-CL8-CURRENT-SAMPLING-EXACT-DYNAMICS uses the strict finite-a frequency mismatch below 25. Corrected primary 93, independently derived rational 87, and integrated 132 checks pass. The parent quantum-boundary gate remains split/open. The active next gate is PA-CP1-CL8-COMMON-FINITE-REGULATOR-CHARACTERISTIC-MODEL, followed by the full finite-a boundary algebra/exact CCR map. Keep physical state and reference selection, below-empty-space comparison, regulator-compatible continuum/Hadamard state, hbar and null-structure origin, C0/N1-N5, phase transition, full 3+1 dynamics, gravity, cooling, cycle, C6 advancement, CP1 and Pre-A open. EXP-000743 advances PA-CP1-CL8-COMMON-FINITE-REGULATOR-CHARACTERISTIC-ROUTE-SPLIT-v0 in fixed-regulator T0 scope. With w=a/8, p=w*Pi and mu=chi*w, the exact D-K-D split is reversible, symplectic and radius-one causal per period; the matching finite-depth unitary is a normal B(H) automorphism with exact density transport, while the quadratic tangent sector is metaplectic with an exact Floquet symbol. NG-2026-08-04-PRE-A-CP1-CL8-NONLINEAR-FLOQUET-WEYL-NORMALIZER, NG-2026-08-04-PRE-A-CP1-CL8-CAUSAL-SPLIT-ORIGINAL-H-STATE, NG-2026-08-04-PRE-A-CP1-CL8-PRINCIPAL-FLOQUET-GIBBS-REFERENCE, and NG-2026-08-04-PRE-A-CP1-CL8-CAUSAL-SPLIT-SIDEWAYS-CHARACTERISTIC separate nonlinear Weyl closure, inherited energy/state stationarity, principal-log Gibbs selection, and two-arm reconstruction. Primary 120, non-importing Fraction independent 99, and integrated 164 checks pass, 383 combined, including stored-freshness, exact parent, algebra-type, record, and unchanged-C6 audits. The parent characteristic gate remains open. The active next gate is PA-CP1-CL8-SIDEWAYS-INVERTIBLE-TWO-ARM-CHARACTERISTIC-CIRCUIT. Keep physical state/reference selection, below-empty-space comparison, regulator-compatible continuum/Hadamard state, hbar and null-structure origin, C0/N1-N5, phase transition, full 3+1 dynamics, gravity, cooling, cycle, C6 advancement, CP1 and Pre-A open. EXP-000745 advances PA-CP1-CL8-PASSIVE-TWO-ARM-CHARACTERISTIC-CONTROL-ROUTE-SPLIT-v0 in claim-nonbearing fixed-regulator T0 scope. On one common even M>=4 phase space, the full-rank passive gate reconstructs every acyclic monotone two-arm cut by exact orthogonal symplectic maps, supplies metaplectic/Weyl and B(H) forward cut maps, a cut-covariant normal Gibbs family, and fixed-algebra periodic stationarity. A q-only kicked local gate remains classically cross-invertible, but NG-2026-08-04-PRE-A-CP1-CL8-PASSIVE-TWO-ARM-NUMBER-STATE-QUARTIC-REUSE refutes automatic reuse of the passive number, vacuum and Gibbs states after the inherited quartic kick. Primary 117, non-importing Fraction independent 114, and integrated 213 checks pass, 444 combined, including one-common-M, stored-freshness, shared-fixture arithmetic, exact record, scope, and unchanged-C6 audits. The active next gate is PA-CP1-CL8-INTERACTING-GATE-TILING-ALL-CUT-INVARIANT-OR-WORK-STATE. Keep strict continuous-variable dual-unitarity, arbitrary periodic two-arm seams, the actual interacting CL8 parent, physical state/reference and below-empty-space comparison, regulator-compatible continuum/Hadamard state, C0/N1-N5, phase transition, full 3+1 dynamics, gravity, cooling, cycle, C6 advancement, CP1, and Pre-A open. EXP-000749 advances PA-CP1-CL8-INTERACTING-TWO-ARM-WORK-ROUTE-SPLIT-v0 in claim-nonbearing inserted-1D fixed-regulator T0 scope. The exact Q3/spatial bond and kinetic coefficient-occurrence ledger supports a new controller-driven nonlinear gate with global gamma^16/eta^16 mixed inverses, every open acyclic monotone cut, interacting B(H) forward-cut density transport, and an exact sign-indefinite work telescope. NG-2026-08-04-PRE-A-CP1-CL8-EXACT-ORDER-EVERY-MICROCUT-SIDEWAYS rejects only the direct attempt to retain inherited q-only/D-K-D micro-order while demanding full rank at every bond cut: the q-only block has rank at most eight, whereas fixed nontrivial G restores rank by creating a new driven order. Primary 140 and non-importing stdlib Fraction/Jet independent 133 checks pass before integrated publication verification. The active next gate is PA-CP1-CL8-CONTROLLER-FREE-COMMON-PARENT-DYNAMICS-INTERTWINER. Keep the positive common invariant/stationary state, 1D-to-3D Q3 parent bridge, arbitrary periodic seams, physical state/reference and below-empty-space comparison, regulator-compatible continuum/Hadamard state, C0/N1-N5, phase transition, full 3+1 dynamics, gravity, cooling, cycle, C6 advancement, CP1, and Pre-A open. Publication verification adds integrated 222/222; primary 140/140 plus independent 133/133 plus integrated 222/222 gives 495/495 total checks, including hostile M=6/negative-step cross-agreement, stored-result freshness, exact records, generated surfaces, scope firewalls, and unchanged C6 status. EXP-000750 corrects the executable q-only opposite-leg cross-block sign: V_WS=-(w*c/a^2)I implies -tau*V_WS=+(tau*w*c/a^2)I, giving +3/64 on F0 and -7/360 on the negative-step F1 fixture. Rank eight, zero determinant, the narrow microcut no-go, and all positive driven work/transport conclusions are unchanged. Explicit signed oracles now give corrected primary 141/141, independent 134/134, and integrated 224/224 checks, 499/499 total; these counts supersede the earlier 495-count note. The next gate remains PA-CP1-CL8-CONTROLLER-FREE-COMMON-PARENT-DYNAMICS-INTERTWINER.
...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-166 v1.1 strengthens the fixed side-16 exact nonaliased p:2p strict-past / single fresh-4p fibre without adding a result ID: the unchanged rational lower certificate is strictly above -4/5, so the owner plus explicit source Hessian is above 1/10 and the scoped R-164 reduction permits rho=3/20, full semiconvexity 31/220 and epsilon_v=367/880. Exact two-harmonic arithmetic registers that the coefficient-one direct lemma does not tensorize to simultaneous fresh-4p and fresh-8p support; the complete joint sextic Gram must be retained. T-050 remains backlog/open because the actual complete production cylinder, earlier-root and cross-root owner, shifted low variables, random/nonlinear/revisit feedback, and regulator/removal uniformity are not assembled. The next decisive target is to freeze one canonical finite cylinder with the actual syntheses, square-root bases, raw/past/future covariances, heat/root incidence, and complement, historical-low, forest and returned-mean placement; then differentiate its scalar once and count forward, legal reverse, balanced, low, current, trace, future, forest, projected-force and sextic terms exactly once. In parallel keep T-054/T-052 truth-first candidate evaluation active without privileging BCC, morphology, or any PDE.
