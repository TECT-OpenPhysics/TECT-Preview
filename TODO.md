...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-166 closes the complete R-165 amplitude annulus on the fixed side-16 exact nonaliased p:2p strict-past / fresh-4p twelve-dimensional conditional fibre with unit retained regulator multipliers and positive floor. The exact Pauli-Fierz radial-Gram split, fresh-current Fourier nonresonance, floor-uniform correction bounds, and direct harmonic coercivity prove K_owner >= -9I/10 for every whitened past amplitude G>=0; the unique polynomial minimum lies in 70<G_*<71 with exact positive 9/10 margin. T-050 remains backlog/open because the complete multi-root production owner, other harmonics and cross-root blocks, shifted low variables, random/nonlinear/revisit feedback, and regulator/removal uniformity are not assembled. Next transfer the exact owner-first decomposition to additional roots and cross-root blocks and count forward, legal reverse, balanced, low, current, trace, future, forest, projected-force and sextic terms exactly once. In parallel keep T-054 truth-first candidate selection active and use the completed T-052 exclusion of nonzero equilibria for the current pinned M1/P1 functional as a filter, without privileging BCC, morphology, or any PDE.
  - _updated 2026-08-03_
