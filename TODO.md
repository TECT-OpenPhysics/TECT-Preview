...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 remains the frozen deterministic shifted-state boundary. EXP-000720--EXP-000729 restore the complete R-141 owner, reject first-derivative, isolated H22, pointwise Foellmer, and finite-bank shortcuts, and park T-050 without a cheap route. EXP-000732 derives the exact q=10/9 tilted-law identity: closure requires the unresolved complete signed trace-excess estimate, while integrated Follmer Jacobian control is a new cutoff-uniform Fisher or occupation theorem rather than a consequence of point curvature. EXP-000733 reduces the legal sparse p:2p:4p chart exactly to a 12 by 12 PSD matrix over 24 past coordinates, generically 22 after translation and common-phase quotients, with rational Gaussian entries reduced to theta and one Laplace variable. No interval-certified compact annulus or cutoff-uniform owner-legal lift exists, because the canonical last-root filtration grows its realized past with cutoff. T-050 stays parked. Reopen only with a complete fresh-averaged production quotient including every owner once, a separately proved cutoff-uniform integrated endpoint estimate, or a new scheme-independent global-action argument. The main lane is truth-first T-054; T-053 is reserved for surviving candidates.
  - _updated 2026-08-03_
