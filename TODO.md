...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-163 supersedes the R-162 single-chain boundary for every finite injective pure-dyadic deterministic-matrix forest: the exact two-sided covariance words retain the mandatory recursive edge, make the worst current-current weight square summable in d=3, include common-ancestor BB* words without cross-chain orthogonality, and transfer the R-160 origin gap to a cutoff-, depth-, and forest-cardinality-uniform neighbourhood. It also sharpens the sufficient complete reduced-action target to mu>-1/110, equivalently K_owner^red > -10/11 G_src after the explicit 9/10 source Hessian, together with a cutoff-uniform absolute anchor and origin-force bound. This does not prove those three production estimates. Random/nonlinear/revisit laws, branching or merging charts, realised-past pathwise conditional semiconvexity, removal, and T-050 remain open. Freeze the deterministic injective-forest theorem after verification; keep T-050 parked unless a truth-first surviving candidate supplies the complete one-use owner plus anchor and force. The main lane remains T-054, followed by T-052 early selection and T-053 survivor excitation tests, without privileging BCC, any morphology, or any PDE.
  - _updated 2026-08-03_
