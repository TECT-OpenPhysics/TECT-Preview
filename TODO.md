...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-130 fixes the post-recombined Xi terminal, finite response-before-pullback order, exact six-row Gram envelopes, sharp balanced bridge, and centered-heat direct-low candidate. Next: prove A13-CLASSII-OWNER-COMPLETE-TRACE-EXCESS-PHYSICAL-RESPONSE-FORWARD-BALANCED-LOW-BOUND by constructing the uniform owner-complete A1 physical response; prove spatial C_mix/C_far and global c_bal with all owners once; establish production matching energy and low transversality or D,K,R0,S0 plus the absolute anchor; then apply R-129 coanalysis and shifted Douglas for one strict three-channel gap. Both A13 gates, OVERLAP_src, Nelson, removals, the interacting measure, and Sector A remain open.
