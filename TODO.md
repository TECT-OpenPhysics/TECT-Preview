...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - Primary phase-neutral physical-model route. R-156 is a genuine fixed-cutoff nonzero-neighbourhood A13 advance but supplies no phase or PDE verdict and no global nonlinear/revisit estimate. Freeze primary-source discovery and holdout evidence; register M0/M1 plus at least two structurally distinct candidate functionals; build the common discriminator matrix; use T-052 to reject candidates early; spend T-053 only on survivors. A justified shortlist, non-selection, or evidence against the present PDE is valid. Keep only the quantitative intrinsic-operator or genuine-counterexample T-050 successor in parallel; do not let further qualitative local A13 lemmas delay the model tournament.
...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-156 instantiates the actual two-stage shifted-state chart and derives the intrinsic source Gram, complete one-scalar production Hessian, projected-force connection, legal adjoint, balanced cross, endpoint/current, trace, sextic, and exact two-block Schur target without an invented low reserve. Continuity from the R-155 pure-dyadic 147/1000 origin gap gives an existential nonzero fixed-cutoff coefficient neighbourhood above 1/10 with exact headroom 47/1000. The rank-one R=2 witness retires global nonlinear-pullback source convexity but is not an intrinsic counterexample. T-050 remains open. Do not add another qualitative chart or low lemma: quantify the intrinsic production-operator variation on the smallest required predictable chart or find a genuine intrinsic counterexample. Keep T-054 in progress, use T-052 for early candidate rejection, and reserve T-053 for survivors. R-156 selects no phase and validates or replaces no PDE.
  - _updated 2026-08-02_
