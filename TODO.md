...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-127 proves the exact blockwise predictable source adjoint and quotient CM Riesz vector, derives the q=10/9 force-square cost 5/9, improves conditional mixed/far aggregation by weighted Schur, and extends the Loewner test through the low/injected channel. It retires unrestricted C_JG collapse, generic low coupling at saturation, and normalized-relative-data recovery of an absolute anchor. Next prove one common endpoint/source-Hessian identity for the fully assembled R-093 action, then bound its forward/legal-reverse/balanced/low matrix with every covariance, heat, cluster, R-063 forest, rational, 2680/729 Cartan, low, injected, and mean owner present once. Both A13 gates, OVERLAP_src, Nelson, removals, interacting measure, and Sector A remain open.
