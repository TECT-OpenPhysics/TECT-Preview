...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711 (PA-CP1-LT3-RS-v0) and EXP-000712--EXP-000713 (PA-CP1-ST8-CB-v0 plus its units correction) form one finite-local branch, not two independent candidates. LT3 retains its exact same-H classical ordering sign, 256 minima and fixed-N symmetric quantum ground, while ST8 proves that the full v0 Hamiltonian is exactly eight decoupled folded coarse phi4 species. Its newly declared spacing family has only fixed-band harmonic convergence and a speed bound sqrt(c_phys/chi); the 3,5,5 PA-H1 tangent requires an inserted species, axis, sector and tuning, and continuous-time semidiscrete propagation has no exact strict support cone. Primary 67, independent 37 and integrated 62 ST8 checks pass, 166 combined. EXP-000714--EXP-000716 and PA-CP1A-T3-CUBIC-SOS-COMMON-PARENT-v0 remain a parallel non-product T0 control: the fitted Fourier symbol matches 3,5,5 at r=0 and proves an ordered window at r<0, but calibration and ordering use different r, nonlinear harmonics leak, the node cone is anisotropic and ultraviolet group speed is unbounded; primary 38, independent 33 and integrated 82 checks pass with a deterministic seven-page PDF. Neither branch identifies physical empty space, selects the PA-H1 state or boundary, proves an interacting or quantum continuum limit, supplies cooling/controller work, or closes CP1 or Pre-A. Next test a minimal registered parity-mixing connected repair and a cutoff-uniform quasi-local/continuum or exact-causal parent under T-053, while keeping CP1a as the non-product comparator, before CP1b/CP2; reject any route that erases the same-H ordering or the normalization and work ledgers.
