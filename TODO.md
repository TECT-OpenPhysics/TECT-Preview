...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000713 establish the LT3/ST8 finite-local branch. EXP-000714--EXP-000716 retain CP1a as a fitted non-product comparator. EXP-000719 and PA-CP1-ST8-Q3LOCK-v0 give the nonlinear quartic species lock with exact two-minimum same-H classical ordering, but retain inserted block origin, symmetric finite quantum ground and no physical empty-space comparison. EXP-000724 and PA-CP1-FD-C1-STRICT-CONE-NOGO-v0 resolve the exact finite continuous-time cone fork: an open-neighbourhood strict cone at a finite-dimensional autonomous C1 equilibrium forces all projected flow-Jacobian powers to vanish, while exact ST8/Q3LOCK and CP1a fixtures have arbitrarily-small-time tails. EXP-000725 repairs an independent Q3 ordered-fixture v^2 omission and pins both CP1a calculations to upstream alpha=1/256,beta=21/512. Corrected primary 42, independent 34 and integrated 63 checks pass, 139 combined. This does not reject Lieb-Robinson quasi-locality, a controlled hyperbolic continuum limit, discrete-time or enlarged causal parents, or QFT microcausality. Next construct PA-CP1-CL8-GOURSAT-v0 using the same a^3/8 and rho=h^3*Pi ledger: transverse-zero eight-species continuum Goursat map, energy and symplectic flux, O(a^2) smooth-data semidiscrete convergence and tail disappearance, and one supplied classical boundary-measure pushforward. Keep block-origin restoration, full 3+1 dependence, quantum continuum and selected state, physical empty space and below-empty-space sign, cooling, CP1 and Pre-A open.
