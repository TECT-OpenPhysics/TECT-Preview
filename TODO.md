...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-138 proves the conditional scale-graded direct theorem with factor 3/(40P) and margins 1/15, 4/15, and 16/15, while an exact rational high-prefix family rejects chronology-only spatial grading. It proves the signed fixed-chart R-079 current--trace last-insertion telescope; positive-square replacement fails. Reveal-to-insertion reanchoring costs 2^(2 gamma(k-r)), equals 128 at gap six, and leaves a reveal-FAR/insertion-near signed wedge, so bare R-135 plus an unweighted q_k sum is insufficient. Sharp scalar charge and conditional collar criteria are now explicit. Next: continue A13-CLASSII-COMPLETE-RAW-DOOB-DIRECT-FUTURE-SPATIAL-ONE-USE-BOUND by proving the production scale-grade/complete-owner intertwiner, then either a causally weighted future q_(r,k) ledger plus the signed near wedge or a direct whole-signed-owner estimate, followed by one deterministic once-owned total and genuinely positive collar headroom. Both A13 gates and Sector A remain open at T4.
