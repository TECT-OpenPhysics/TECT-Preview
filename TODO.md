...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000707 is the current strict-interface authority and continues EXP-000703. PA-H1-M2-STRICT-COMPOSITION-NOGO-v0 proves that the present six-dimensional PA-H1 finite image and sixteen-dimensional PA-M2 CI8 phase space cannot be identified unchanged as one exact state-, energy-, dynamics-, and regulator-preserving interface. A canonical symplectic injection exists, but it leaves a ten-dimensional complement with nonunique positive quasi-free state extensions. For g>0 the quartic leading degree blocks every all-amplitude affine symplectic energy match; the PA-H1 squared frequencies 9 and 25 cannot both intertwine with the single repeated PA-M2 zero-background value r/chi, even after constant time rescaling; and the unprojected cubic force leaks CI8 stripes to 3Q with omitted norm 1/32. Independent additive energy constants preserve internal dynamics and can reverse every cross-model sign: the PA-H1 normal-ordered zero versus raw 13/2 and the PA-M2 internal phi=0 reference do not prove energy below empty space or the no-condensate reference. The invariant PA-H1 vacuum generates no nonconstant state-only r(tau), while nonvacuum finite-interval crossings, time-dependent interfaces, dynamic clocks, ordered backgrounds, enlarged regulators, nonlinear/holographic maps, and a richer common parent remain open. Primary 56, non-importing independent 41, and integrator 186 checks pass, 283 combined. Neither upstream scoped result is invalidated and Pre-A remains open. Next construct CP1: one finite-regulator three-torus parent Weyl algebra, Hamiltonian, selected state, volume, boundary, hbar, counterterm, and relative-energy ledger that derives both the characteristic-boundary role and the PA-M2 ordering sector. Then construct CP2: a dynamical control pair or preregistered nonstationary interacting state that proves a finite-time r=0 crossing with total-energy accounting. Retain the current 1+1 PA-H1 theorem as a calibration rather than silently treating it as the physical upstream component.
...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 closes the actual shifted-state nonzero neighbourhood for one finite acyclic pure-dyadic deterministic-matrix chain at the fixed side-16 d=3 expected/global A1/A7 scope. A strict-lower-shift resolvent, the R-155 stationary p-to-4p connection cancellation, exact dyadic synthesis, Q-Q0 normalization, and the complete source/current/trace/projected-force/sextic modulus retain a 13/100 pullback gap and more than 1/10 of the induced recursive Gram, uniformly in finite chain length, starting mode, finite cutoff, and admitted regulator. Freeze this single-chain boundary. T-050 remains parked at actual arbitrary forests, random or nonlinear realised-past coefficients, revisit/cycles, and the pathwise complete conditional Hessian. Reopen direct A13 only with that production law or a counterexample; shift the main lane to truth-first T-054 without privileging BCC, any morphology, or any PDE. T-052 remains closed for pinned M1 and T-053 is reserved for survivors.
  - _updated 2026-08-03_
