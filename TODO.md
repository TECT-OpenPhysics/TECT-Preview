...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000725 retain the LT3/ST8/Q3LOCK finite-local branch, CP1a comparator, and strict-cone boundaries. EXP-000728 separates CL8 Goursat and semidiscrete Cauchy theorems; EXP-000730/731 resolve the classical interface and formally refute generic unchanged same-domain periodic wrapping while retaining the matched seam and declared larger-circle alternative. EXP-000734 closes only PA-CP1-CL8-FULL-CIRCUMFERENCE-GOURSAT-EXISTENCE in the declared finite-triangle fixed-background classical scope; EXP-000735 corrects its cumulative high-regularity recursion by retaining D_(m-1). The exact proof shift C_star=2*r_minus^2/g, one-eighth null-flux identity, amplitude bound S_tau=max trace norm+4*sqrt(2*s*tau*Fcal_tau/c), and trace-dependent uniform Volterra shells give global existence and uniqueness; the I0 bound gives field stability, and the corrected differentiated cubic-force induction supplies compact-family C8-to-C7-by-C6 phase-map bounds. Triangles whose final-slice length equals the inserted L=pi/2 ordered PA-H1 value are covered although the old one-patch factors 9*pi^2/32 and 9*pi^2/64 remain greater than one. A backward-evolved nonconstant periodic Cauchy family shows the seam-compatible trace image is nonempty; it does not make arbitrary traces periodic. Corrected primary 63, independent 60 and integrated 148 checks pass, 271 combined, with stored-result freshness and final independent referee PASS. Next attack PA-CP1-CL8-PREFERRED-STATE-COMPOSITION-SELECTION. Keep the registered strict-cone and periodic-composition negatives, canonical extension, preferred or invariant measure, quantum or Hadamard state, physical vacuum and below-empty-space comparison, finite-a characteristic scheme, growing-time or thermodynamic limit, full 3+1 dynamics, gravity, C6 advancement, CP1 and Pre-A open.
