...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-164 discharges the separate direct zero-control anchor and origin-force hypotheses left by R-163. The R-141 legal force is the predictable first-chaos projection of the complete centered terminal scalar, so its squared source-dual norm is bounded by B_* uniformly in cutoff, finite chart length, and independent-Gaussian linear/isometric refinements on the registered sharp-cube/dyadic sequence; A7 centering makes the direct anchor nonnegative. The exact remaining direct analytic inequality is the complete one-use owner bound K_owner >= -(10/11-rho)G_src for one uniform rho>0, which would give mu=-1/110+rho, epsilon_v=max(0,5/11-rho/4), epsilon_6=3/20, and constant B_*/rho. T-050 remains backlog/open: assemble forward, legal reverse, balanced, low, current, trace, future, forest, projected-force, and sextic contributions exactly once, or retain a failed generalized eigenvector as a legal counterdirection. Shifted low bases, nonzero feedback, full graph metric transport, random/nonlinear/revisit, pathwise conditional scope, and removal remain separate gates. Continue the T-054 truth-first candidate lane in parallel without privileging BCC, morphology, or a PDE.
  - _updated 2026-08-03_
