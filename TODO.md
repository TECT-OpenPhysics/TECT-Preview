...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - EXP-000791 keeps the parent PA-ROUND1 evidence and manifest gate open pending a genuinely future relation and microscopic map. On the ST8/Q3LOCK lane, EXP-000792--802 / R-167 v1.0--v1.5 establish the local derivation, weighted-energy and graph precursors, the fixed-beta canonical OS-mixture KMS envelope, and selected tangent-net finite-core Hamiltonian identification. EXP-000803 advances R-167 to v1.6: the modular right-context lemma and recursive Fejer smoothing give every fixed finite raw configuration-orbit word moment and Gram block on the selected tangent nets; the exact zero-source finite Hamiltonians define one beta-independent universal L1 orbit-smear C-star carrier; and the EXP-000789 broken doublets yield two distinct algebraic ground states of its common C0 shift. This carrier is categorical and nonlocal, not the quasi-local thermodynamic oscillator alpha. The live CP1 gate is PA-CP1-ST8-Q3LOCK-QUASI-LOCAL-RAW-OSCILLATOR-ALL-EXHAUSTION-COMMON-ALPHA-AND-BROKEN-GNS-GAP: prove a spatial raw or resolvent carrier, all-shape exhaustion Cauchy, phase-KMS quotient and local-generator identification, then the broken-sector GNS gap. Static tails alone do not close projected orbit locality. Continuum, physical empty space, C6, CP1, Sector A and Pre-A remain open. The single v1.6 gate-level synthesis PDF is claims/C6-SPACETIME-SIGNATURE/notes/pre-a-q3lock-universal-orbit-smear-ground-doublet-route-split-260810-v0.5.pdf; it was issued only after strict proof validation and does not alter the open successor.
