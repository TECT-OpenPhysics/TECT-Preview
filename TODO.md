...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - EXP-000791 keeps the parent PA-ROUND1 evidence and manifest gate open pending a genuinely future relation and microscopic map. On the ST8/Q3LOCK lane, EXP-000792--803 / R-167 v1.0--v1.6 establish the local derivation, weighted-energy and graph precursors, the fixed-beta canonical OS-mixture KMS envelope, selected tangent finite-word Hamiltonian identification, and the categorical beta-independent orbit-smear carrier with two algebraic ground states. EXP-000804 advances R-167 to v1.7: every fixed finite-region multiplier algebra has an exact bounded local-strict/strong-star/energy topology in which the onsite and commuting bond subflows are continuous and energy controlled; exact full-Q3 packets reject point-norm continuity on raw momentum-Weyl/basic-resolvent labels; the pure quartic kick does not preserve the full resolvent algebra; finite-Gibbs character entropy gives only an inverse-logarithmic tilted tail; and ordered ground-state distinctness does not imply a GNS gap. The former combined successor is split. The live dynamics gate is PA-CP1-ST8-Q3LOCK-LOCAL-STRICT-ALL-EXHAUSTION-TWO-ORIENTATION-HISTORY-COMMON-ALPHA; separately, PA-CP1-ST8-Q3LOCK-BROKEN-SECTOR-GNS-GAP-COERCIVITY requires a sectorwise positive coercive estimate. Continuum, physical empty space, C6, CP1, Sector A and Pre-A remain open. Per the PDF-efficiency protocol, no per-lemma or intermediate v1.7 PDF was issued. After the manifest, certificate, primary, non-importing independent, and integrated proof layers passed, the single nine-page v0.6 gate-level synthesis source/PDF pair was issued and every rendered page passed visual review.
