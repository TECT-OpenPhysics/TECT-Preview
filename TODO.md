...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-156 remains the direct A13 frontier. The exact intrinsic sufficient-radius criterion is L_R*r*sqrt(1+r^2/16)+2*U_0*sqrt(2*(1-(1+r^2)^(-1/2)))<47/1000, with U_0 the origin shifted operator norm and L_R a pinned third-variation modulus on the smallest source cylinder. The current authorities do not pin the cutoff/regulator/source basis, U_0, or L_R, so no honest numerical or cutoff-uniform delta follows; no intrinsic counterexample was certified. Park new qualitative chart/low lemmas. Resume only by pinning one actual finite production cylinder and interval-certifying U_0 and L_R, or by finding a genuine intrinsic counterexample. R-157 is separate and does not close T-050 or A13.
  - _updated 2026-08-03_
