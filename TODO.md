...
- **T-061** Dynamic-owner and observation-map identifiability intake  _(owner: Codex; gate: PA-INVERSE-OBSERVATION-TARGET-MAP-HOLDOUT-FREEZE)_
  - R-468 / EXP-001343 adds a finite binary-table index for the two rsp2 products: primary 35 assertions, independent core 4 assertions, hostile 10/10, integrated 10/10 and Lean R468 pass; 128 EBOUNDS rows and eight ordered 140-row response segments per detector are verified, three alternatives remain retained with NONE_SELECTED, and response coefficients, validity, detector-to-geocenter conversion, timing uncertainty, likelihood, covariance, nuisance, complete map, scoring and prospective credit remain unadmitted. R-469 / EXP-001344 pins USRA-STI/gdt-core main commit ad506a4a45016bda720ff8d722e9ada49fd32191 and response.py SHA-256 2a5581e8a0b68a5b0eeaa513ec479fef3e6735b04125968ba9f58f89d3e45833. Its strict-overlap drm_index, first/last fallback and first-index nearest delegation are reproduced from R-468 metadata; endpoint fallback and the docstring/implementation mismatch are recorded. Primary 12 assertions, independent 7 assertions, hostile 12/12, integrated 14/14 and Lean R469 pass. The source semantic crosswalk is T0 provenance only: no source-owner validity/interpolation, timing uncertainty, likelihood, covariance, scoring or method change. Existing T-054/T-059/T-061 methods, owner order and promotion firewalls remain unchanged. Next: request the versioned source-owned validity/interpolation, time-standard and timing-uncertainty contract; keep all alternatives and scoring locked.
  - _updated 2026-08-31_
