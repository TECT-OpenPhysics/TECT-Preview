...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-132 proves the exact common-heat paired-replica response and complete mixed Pauli--Fierz identity, the diagonal heat--sextic constants with an exact origin no-go against promotion, a law-free two-point inverse-floor obstruction, a positive standard-Gaussian source--sextic scalar-ray margin above 3/4, and the exact R-091 shell-exponent deficit. Next: prove A13-CLASSII-PRODUCTION-GAUSSIAN-MIXED-REPLICA-SCORE-SHELL-BOUND with all six signed rows, trace, forest, heat, visits, output clusters, rational and 2680/729 Cartan owners retained once; establish the stopped-polynomial intertwiner and a complete gamma=4 rational one-use estimate or stronger signed cancellation; then derive production C_mix/C_far/c_bal, low D/K/R0/S0, matching energy, the absolute anchor, and apply R-129 shifted Douglas once. Both A13 gates, OVERLAP_src, Nelson, removals, the interacting measure, and Sector A remain open.
