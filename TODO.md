...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - EXP-000791 freezes the bounded T-053 evidence-role inventory and honest no-survivor matrix, but its parent PA-ROUND1 evidence/manifest gate remains open until a genuinely future or blind relation and microscopic observable map are frozen before scoring. On the ordered ST8/Q3LOCK lane, EXP-000792 proves the common local derivation and first weighted-energy cone, EXP-000793 repairs the basic-resolvent obstruction, and EXP-000794--795 / R-167 prove the exact second and three-half moments plus conditional two-sided thermodynamic Cauchy. EXP-000796 strengthens R-167 to v1.1 without a new result number: the exact graph expansion and Heinz--Kato close the optimal centered q^3 A^-3/4 multiplier, Q3 cubic force and neighboring-center comparison, while every prescribed bond word gets a Gamma(1+n/2) heat-simplex denominator. Its historical gates PA-CP1-ST8-Q3LOCK-FIRST-PASSAGE-BACKBONE-REAL-TIME-PRODUCT-AND-ENERGY-TAIL-CLOSURE and PA-CP1-ST8-Q3LOCK-FIFTH-ENERGY-MOMENT-AND-MODULAR-CUTOFF-LOCALITY remain recorded. EXP-000798 advances R-167 to v1.2: exact star/repeat commutators falsify the fixed-s coefficientwise first-passage target although the full star resums unitarily; a tree formula survives and a square exposes the loop remainder. The exact modular-mean and multiplier lemmas plus imported Euclidean exponential moments close coordinate-cutoff static/modular tails, while an arbitrary-multiplier fixture isolates the remaining topology obstruction. The active alternatives are PA-CP1-ST8-Q3LOCK-ALL-BOND-UNITARY-TROTTER-GRAPH-LIPSCHITZ-AND-COMMON-ALPHA-CLOSURE and PA-CP1-ST8-Q3LOCK-PROJECTED-DUHAMEL-MODULAR-C1-MULTIPLIER-LOCALITY. Common alpha/KMS, algebraic ground states, GNS gap, continuum, physical empty space, C6, CP1, Sector A and Pre-A remain open.
