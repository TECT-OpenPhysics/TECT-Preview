...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - EXP-000791 keeps the parent PA-ROUND1 evidence and manifest gate open pending a genuinely future relation and microscopic observable map frozen before disclosure. On the ST8/Q3LOCK lane, EXP-000792--804 / R-167 v1.0--v1.7 establish the local derivation, weighted-energy and graph precursors, fixed-beta canonical OS-mixture envelope, selected-tangent finite-word identification, categorical orbit-smear carrier with two algebraic ground states, and finite-region local-strict plus finite-Gibbs entropy-tail split. EXP-000805 advances R-167 to v1.8 without closing either parent: every fixed finite Trotter word is exactly exhaustion-compatible in its finite halo; a uniform sandwiched-Renyi history bound is sufficient for the missing two-orientation Gaussian corridor; zero-temperature GNS gap, phasewise coercivity and a common OS temporal mass are equivalent under the simple-vacuum/form-core hypotheses; the isolated Q3 instanton action minimum and a conditional doublet-Ising reference gap are exact. The registered entropy, finite-moment and energy-form controls do not automatically supply the Renyi estimate, and direct two-phase Yarotsky import lacks the required exact product-doublet and perturbative hypotheses. The live mathematical gates remain PA-CP1-ST8-Q3LOCK-LOCAL-STRICT-ALL-EXHAUSTION-TWO-ORIENTATION-HISTORY-COMMON-ALPHA and PA-CP1-ST8-Q3LOCK-BROKEN-SECTOR-GNS-GAP-COERCIVITY. Continuum, physical empty space, C6, CP1, physical Sector A and Pre-A remain open. One v0.7 gate-level synthesis is authorized only after all source, formal, independent and integrated checks pass.
