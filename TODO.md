...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000713 establish the LT3/ST8 finite-local branch: the same-H classical sign survives, but ST8 factorizes exactly into eight decoupled folded coarse phi4 species and its continuous-time regulator has no exact strict support cone. EXP-000714--EXP-000716 and PA-CP1A-T3-CUBIC-SOS-COMMON-PARENT-v0 are a parallel fitted non-product control that matches the 3,5,5 quadratic calibration at r=0 and proves an r<0 ordering window, while calibration and ordering use different r, nonlinear harmonics leak, the cone is anisotropic and ultraviolet group speed is unbounded; primary 38, independent 33 and integrated 82 checks pass. EXP-000719 and PA-CP1-ST8-Q3LOCK-v0 are the nonlinear connected repair: a positive local quartic Q3 lock has zero origin Hessian, preserves the eight bare ST8 critical species modes, reduces the 256 sign minima to two, and keeps H_min=-N^3*r^2/(4g)<H(0,0)=0. Its ordered species shifts are 0,2,2,2,4,4,4,6 times lambda*v^2, and the collective singlet is an exact invariant classical reduction. NG-2026-08-03-PRE-A-CP1-Q3LOCK-QUADRATIC-CONNECTIVITY-CI8 shows that positive quadratic connectivity would instead reduce critical nullity to one. Q3LOCK primary 54, independent 36 and integrated 74 checks pass, 164 combined. The lock and block origin are inserted, fine one-site translation is broken, the finite quantum ground is symmetric, and neither candidate identifies physical empty space, selects the PA-H1 boundary state, proves regulator removal or an interacting quantum continuum, supplies cooling/controller work, or closes CP1 or Pre-A. Next use the a^3/8 and rho=h^3*Pi ledger for a smooth-data classical Goursat and symplectic-flux limit, register the analytic finite-continuous-time strict-cone obstruction, and test an exact-causal energy-preserving quantum automorphism while retaining CP1a as the non-product comparator.
...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 remains the frozen deterministic shifted-state boundary. EXP-000720 corrects the route interpretation after EXP-000718: Dh and D2h obstruct forest-alone or factorized score estimates, but the complete R-125 variance-minus-forest owner recombines to the derivative-free R-141 endpoint Hessian. EXP-000721 proves that even a uniform first-derivative and bi-Lipschitz collar does not bound the corrected second score. EXP-000722 proves that bounded canonical Foellmer control energy does not imply time-integrated horizontal Jacobian control; a Markov route now requires an actual cutoff-uniform A1/A7 tilted-covariance or second-score theorem. EXP-000723 rejects promotion of the R-149 active-spectator H22 sign: the legal p:2p source symbol suppresses the UV shortcut, while a separated high-past/low-final ansatz leaves the registered chart and owes the full multiroot owners. T-050 stays parked. Reopen direct A13 only with one legal finite production chart and the complete fresh-averaged Rayleigh quotient (K_E+K_6)/G, including forest/future, reverse, balanced, low, sextic, source, and connection owners once, or with the target-specific tilted-law theorem. The main lane remains truth-first T-054; T-053 is reserved for surviving candidates.
  - _updated 2026-08-03_
