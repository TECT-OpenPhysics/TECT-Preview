...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-156 remains the direct A13 frontier, but EXP-000685 establishes that no canonical finite production cylinder is currently hash-pinned: A7 defines a regulator class rather than one cutoff/multiplier. The exact sufficient-radius criterion remains L_R*r*sqrt(1+r^2/16)+2*U_0*sqrt(2*(1-(1+r^2)^(-1/2)))<47/1000, but computing U_0 or L_R now would require a new scheme choice. Park new qualitative lemmas and discretionary finite-cylinder numerics. Resume only if T-054 selects a candidate that explicitly pins the regulator, cutoff, output convention, covariance subtraction, filtration, and complete scalar owner, or if a genuine scheme-independent intrinsic counterexample is proved. R-157 is separate and does not close T-050 or A13.
  - _updated 2026-08-03_
