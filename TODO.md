...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-148 proves only that the exact rank-one R-147 fresh innovation cannot be inserted unchanged as a nonzero R-146 proportional-covariance final block; a rank-one past is merely the no-correction fixture, and a new full-rank chart remains possible. Its separate last-root coefficient chart gives a pointwise small-noise mismatch and coefficient-background parameter derivatives, not a physical control Hessian or registered-owner transport. Continue two legal phase-neutral forks: derive a full-rank canonical owner chart, or compute the registered old-chart owner-complete active-spectator residual directly. Retain shared-probe trace, Doob bracket, adapted R-063 forest, future variance, balanced rows, returned low, spatial owner, and terminal sextic exactly once; specify physical source/control synthesis before interpreting a Hessian; test eta<5/11 and zeta<13/50. T-050, A13, Nelson, all phase selection, and Sector A remain open.
