...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-160 closes the arbitrary-finite R-155 fixed-law affine origin union at its honest scope. Exact factor-three block sparsity and d_j=4^(-j) weighted Schur give the continuous-half-line gap 19/160 and stronger actual side-16 lattice gap 4/25, uniformly in every finite family cardinality and path length, with source-target reuse allowed but distinct one-shot raw sources. This is origin-only at fixed cutoff and positive floor; it gives no cardinality-uniform nonzero neighbourhood, realised-past fibrewise bound, shifted-state/revisit law, nonlinear predictable theorem, or cutoff/floor removal. Keep T-050 parked at that genuine conditional-Hessian globalization boundary. Resume only for such a theorem/counterexample or when a truth-first T-054 survivor pins the complete production law. No morphology or PDE is privileged.
  - _updated 2026-08-03_
