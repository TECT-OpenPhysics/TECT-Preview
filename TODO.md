...
- **T-061** Dynamic-owner and observation-map identifiability intake  _(owner: Codex; gate: PA-INVERSE-OBSERVATION-TARGET-MAP-HOLDOUT-FREEZE)_
  - R-470 / EXP-001345 adds an additive mission-source provenance crosswalk after R-469: the pinned USRA-STI/gdt-fermi main commit a6ef74e7278dbeb35759aadeb8d79ec8c38e6aac and 12107-byte response.py SHA-256 d2c1534ac3fa8eb783ba0a7f13c0e32bdfb7f44c8d0a409b64c7d7cfbfb0a2ba are checked by independent AST/token lanes. GbmRsp2 subclasses core Rsp2, delegates opening, iterates DRM_NUM, rebuilds per-segment headers, accesses MATRIX/F_CHAN/N_CHAN/N_GRP, decompresses rows, constructs ResponseMatrix and GbmRsp objects and aggregates them; no event product or response coefficient is opened. The audited method body supplies no validity, interpolation, timing, uncertainty, likelihood or detector-to-geocenter owner contract. Primary 15/15, independent 10/10, hostile 14/14, integrated 15/15 and Lean R470 pass. This is T0 provenance only, selection remains NONE_SELECTED, and T-054/T-059/T-061 methods, owner order and promotion firewalls are unchanged. Generic software-source intake stops here; next request the versioned physical-owner validity/interpolation, time-standard, propagation and uncertainty contract and resume T-054 owner-level Q3LOCK intake in parallel.
  - _updated 2026-08-31_
