...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - A13 translation-model reduction closes flexible potential coercivity, exact finite-cutoff translation/frame identities, deterministic-shift expectation positivity, the Cartan current identity, and the deterministic-constant remainder no-go. The umbrella one-use theorem remains open. Next prove A13-CLASSII-CAMERON-MARTIN-TRANSLATED-CURRENT-MODEL-LIFT: universal centered Q and coefficient jets with L3-level moments, Cameron-Martin translation continuity, and no new interaction counterterm; then prove a strict-past signed Q/current/curvature form bound. The stress candidate is epsilon_6=0.15, delta=0.06, epsilon_v=0.45. Termwise paraproduct Young and the previously excluded architectures remain forbidden.
