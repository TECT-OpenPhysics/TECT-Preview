...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-FULL-PROGRESSIVE-REVISIT-EXTENSION)_
  - R-103 proves the exact disjoint expectation-level complete-owner partition for the finite-cutoff, fixed-floor, deterministic-PSD-heat, annular mutually orthogonal strict-past no-revisit class. Fixed-low raw Wick remains in the R-080/R-063 low owners; only the R-100/R-101 future reveal is a separate residual; one signed R-078 paid difference is bounded under the fixed R-096 collar; the separate R-086 Q orientations and T_G<= charge are refunded; and the R-102 terminal square remains unspent. Seven modules close complete regular H_N and eight modules close REG with eta*=1/440, zeta*=3/100. The literal naked posterior bracket is unproved and non-load-bearing. Primary 137/137 and independent 69/69 pass; the frozen integrated contract is 379/379 and aggregate 585/585. Next prove lossless progressive/revisit H_A assembly and the uniform OVERLAP_src source-action lower bound, then invoke R-087/R-093 CORE for q=10/9 Nelson. Removals, measure construction, and Sector A remain open.
