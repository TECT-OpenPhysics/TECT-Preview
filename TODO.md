...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-162 remains the frozen deterministic shifted-state boundary. EXP-000720--EXP-000723 restore the complete derivative-free R-141 owner, reject first-derivative, control-energy, and isolated H22 shortcuts, and require either a complete legal production Rayleigh chart or a target-specific tilted-law theorem. EXP-000726, independently factor-audited and scope-corrected by EXP-000727, now proves that the actual relative endpoint density is not log-concave along the constant active-doublet ray: pointwise Foellmer nonexpansion and any cutoff-uniform unweighted global sup-Jacobian collar fail, while an expected time-integrated Fisher or owner-weighted score theorem remains logically open. Direct A13 stays parked; reopen only with a complete fresh-averaged production quotient including every owner once, or a separately proved integrated tilted-law estimate. The main lane is truth-first T-054; T-053 is reserved for candidates that survive the Pre-A tournament.
  - _updated 2026-08-03_
