...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-165 gives the first global-amplitude owner estimate on the actual R-153 sparse production principal fibre. On the fixed side-16 exact nonaliased p:2p strict-past / fresh-4p twelve-dimensional conditional fibre with unit retained regulator multipliers, a sharp 5/6 Fourier separation, exact A1 covariance enclosures, and R-130 derivative bounds prove K_owner >= -9I/10, the R-164 target with rho=1/110, for 0<=G<=21 and G>=274. The unresolved set is the bounded open annulus 21<G<274; its closed certification domain 21<=G<=274 is compact and its endpoints are already certified. T-050 remains backlog/open: next certify the exact twelve-by-twelve matrix on that closed domain by outward-rounded interval subdivision, Bernstein or rational SOS, or refute it with a certified counterdirection in the open annulus, then separately assemble the nonzero complete multi-root owner with forward, legal reverse, balanced, low, current, trace, future, forest, projected-force, and sextic contributions exactly once. Other harmonics, cross-root blocks, shifted low variables, random/nonlinear/revisit feedback, regulator/removal uniformity, T-050/A13, Nelson/measure, and Sector A remain open. Continue T-054 truth-first candidate selection in parallel without privileging BCC, morphology, or a PDE.
  - _updated 2026-08-03_
