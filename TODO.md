...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex; gate: PA-ROUND1-EVIDENCE-ROLE-AND-MINIMUM-MANIFEST-FREEZE)_
  - EXP-000791 freezes the bounded T-053 evidence-role inventory and honest no-survivor matrix, but its parent PA-ROUND1 evidence/manifest gate remains open until a genuinely future or blind relation and microscopic observable map are frozen before scoring. On the ordered ST8/Q3LOCK lane, EXP-000792 proves the common local derivation and first weighted-energy cone, EXP-000793 repairs the basic-resolvent obstruction, and EXP-000794--795 / R-167 prove the exact second and three-half moments plus conditional two-sided thermodynamic Cauchy. EXP-000796 strengthens R-167 to v1.1 without a new result number: the exact graph expansion and Heinz--Kato close the optimal centered q^3 A^-3/4 multiplier, Q3 cubic force and neighboring-center comparison, while every prescribed bond word gets a Gamma(1+n/2) heat-simplex denominator. Its historical gates PA-CP1-ST8-Q3LOCK-FIRST-PASSAGE-BACKBONE-REAL-TIME-PRODUCT-AND-ENERGY-TAIL-CLOSURE and PA-CP1-ST8-Q3LOCK-FIFTH-ENERGY-MOMENT-AND-MODULAR-CUTOFF-LOCALITY remain recorded. EXP-000798 advances R-167 to v1.2 by rejecting fixed-power first passage and isolating all-bond and projected-modular alternatives. EXP-000799 advances R-167 to v1.3: the complete bond kick has a centered energy-graph theorem and exact one-layer commutator recurrence, but the raw basic-resolvent point norm, ordinary and every s<1/2 onsite Lipschitz class, and the coordinate-cutoff half-strip absolute route fail. The exact one-site Q3 boundary layer also rejects every fixed Weyl-containing C-star-Leibniz critical seminorm that dominates a one-sided p commutator and has uniform 1+C|t| onsite growth. A direct finite-Gibbs relative-unitary theorem survives. The primary PA-CP1-ST8-Q3LOCK-ALL-BOND-UNITARY-TROTTER-GRAPH-LIPSCHITZ-AND-COMMON-ALPHA-CLOSURE gate is narrowed to a non-Leibniz analytic/Frechet or symmetric/state-weighted thermodynamic topology and boundary Cauchy. The alternative PA-CP1-ST8-Q3LOCK-PROJECTED-DUHAMEL-MODULAR-C1-MULTIPLIER-LOCALITY gate is narrowed to direct D,delta D locality on a preregistered separating local class; uniform evolved M0,M1 is sufficient but not equivalent. Common alpha/KMS, algebraic ground states, GNS gap, continuum, physical empty space, C6, CP1, Sector A and Pre-A remain open.
