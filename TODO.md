...
- **T-054** Pre-A evidence register and candidate-functional tournament  _(owner: Codex)_
  - EXP-000711--EXP-000725 retain the LT3/ST8/Q3LOCK finite-local branch, the CP1a comparator, and finite-C1 strict-cone boundary. EXP-000728 registered separate CL8 Goursat and semidiscrete Cauchy theorems. EXP-000730/731 resolve and harden their classical interface by exact scope split through PA-CP1-CL8-CLASSICAL-BOUNDARY-TO-LATTICE-OA2-v0. Matched periodic-jet C8 traces initialize the natural same-domain lattice directly. Generic unchanged same-domain wrapping is formally refuted by NG-2026-08-03-PRE-A-CP1-CL8-UNMATCHED-PERIODIC-COMPOSITION: the admitted A=0, B(v)=v e_1 fixture has self-map 47/200, contraction 1/10, endpoint jump 1/5 and wrap energy asymptotic c/(400a). A declared larger-circle Hermite fill survives as a separate noncanonical alternative with H_ext and Omega_ext retained. Exact sampling and the inherited theorem give O(a^2) convergence for fixed bounded H7 x H6 families; trigonometric reconstruction gives common H1 x L2 convergence and supplied compact classical phase measures converge in W1. Hardened primary 55, independent 44 and integrated 135 checks pass, 234 combined. Exact arbitrary-frequency sampling, finite-a support, and the current full ordered PA-H1 one-patch gate remain rejected or open. Next attack PA-CP1-CL8-FULL-CIRCUMFERENCE-GOURSAT-EXISTENCE by multi-patch or global continuation, then PA-CP1-CL8-PREFERRED-STATE-COMPOSITION-SELECTION. Keep canonical extension, preferred measure, quantum state, full 3+1, physical vacuum and below-empty-space comparison, C6 advancement, CP1 and Pre-A open.
