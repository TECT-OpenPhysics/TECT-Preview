...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-CONTROLLED-SHELL-ENERGY-ONE-USE)_
  - R-129 fixes the endpoint-owner direction: E_CN=P_comp+V/2 dominates the smaller R-123 owner and cannot lower-bound it, while endpoint differences have no variance sign. It derives the direct signed Hessian, registers Poincare/entropy/temporal-shell/swapped-band countermodels, and proves the conditional physical-shell/source-coanalysis factorization H=R^*F=F^*R without temporal-shell commutation. This transfers a proved owner-complete physical forward estimate to its true predictable aggregate adjoint, with the ||L_pred|| pullback factor retained. The exact shifted-Douglas theorem supplies the prescribed three-channel gap criterion. The next theorem is A13-CLASSII-OWNER-COMPLETE-TRACE-EXCESS-PHYSICAL-RESPONSE-FORWARD-BALANCED-LOW-BOUND: construct the production response and prove C_mix, C_far, c_bal, low D/K/R0/S0, the absolute anchor, and common-terminal owner once. Both A13 gates, OVERLAP_src, Nelson, removals, interacting measure, and Sector A remain open.
