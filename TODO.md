...
- **T-050** A13: prove the controlled-shell energy one-use bound  _(owner: Codex; claim: A13-CLASSII-RELATIVE-PHASE-SOURCE-BUDGET-OBSTRUCTION; gate: A13-CLASSII-FUTURE-CONTROL-WEIGHTED-INNOVATION-BRACKET)_
  - R-086 rewrites the R-085 shifted-Hessian pair plus endpoint square as one exact translated-Wick third-remainder normal form. A sharp cubic Sobolev theorem pays the base-frozen Q model with total 13/15, slack 2/15, and moment 15/2. All coefficient-nonresonant and payload-comparable shifted branches are form-absorbed with Q/G totals 7/10 and 23/30. The sole rational remainder is the coefficient-dominant high--high-to-low packet coupled to the endpoint square, Wick trace, and lower-chaos forest. Exact Taylor-Gram, endpoint-kernel, and vanishing-heat fixtures exclude positivity, endpoint-square-only Schur, and uniform inverse-heat-Gram shortcuts. Next prove that coefficient-dominant packet and the independent R-085 mixed Cartan atom estimates (4.10)--(4.11), then REG, OVERLAP, CORE, controlled-shell one-use, and q=10/9 Nelson. Sector A remains open.
