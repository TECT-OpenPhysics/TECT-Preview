...
def build_data() -> dict[str, object]:
    ...
    return {
        ...
        "graph": graph,
        "lookup": {
            "event_by_id": {identifier: event_by_id[identifier] for identifier in sorted(event_by_id)},
        },
    }
...
def render_markdown(data: dict[str, object]) -> str:
    ...
    lines += [
        ...
        "`verification/proof-evidence-map.json`; the canonical narrative is `CHANGELOG.md`.",
        "",
