...
"""
__version__ = "1.2.0"  # 1.0.1 (2026-06-09): sort sub-proof folders by name, not by
...
# 1.2.0 (2026-07-24): remove wall-clock timestamps from generated output so
#                      regeneration and staleness checks are deterministic.
...
def per_claim_index(cid):
    ...
    for name, paths in groups:
        ...
        L.extend(rows)
        L.append("")
    L.append(f"<!-- generated by build_index.py v{__version__} -->")
    return "\n".join(L) + "\n"
