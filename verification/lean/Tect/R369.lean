...
/- R369 checks the exact finite fixture arithmetic and the scalar weighted
   envelope used by the source-translation/shape stress.  Matrix spectra,
   common cores, and regulator limits remain outside Lean. -/
