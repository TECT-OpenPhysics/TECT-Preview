...
- `scripts/build_proof_evidence_map.py` — deterministic global proof-route projection: `theory/proof-evidence-map.md` + `proof-evidence-map.json`, with registry coverage, graph, and staleness checks.
