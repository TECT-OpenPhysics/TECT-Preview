...
| [R-167](#r-167) | Weighted-energy, full-oscillator selector, maximal continuous-element/KMS cores and common-dynamics route split | R-167 v2.9 is a scoped T0 analytic/exact/executed/audited additive result under EXP-000833. It retains every v2.8 child, proves one exact full-oscillator selected phase after a bounded doublet selector, identifies finite/product/fixed-beta-OS maximal continuous parts, and registers three exact implication failures; selector removal, zero-source two-phase transfer, spatial all-shape common alpha, broken-sector GNS gap, C6, Sector A and Pre-A remain open |
