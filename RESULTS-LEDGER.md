...
| [R-167](#r-167) | Essential-range multiplier, joint cylinder, zero-source and common-dynamics route split | R-167 v3.1 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000835. It retains every v3.0 child, proves the finite-volume `L_infinity` essential-range norm-jump theorem and joint canonical standard-cylinder scalarity, and registers the strictly strengthened multiplier boundary; exact-Q3 dressed shell estimates, common alpha, two-phase full-oscillator transfer, target-generator convergence, broken-sector GNS gap, C6, Sector A and Pre-A remain open |
