...
| [R-167](#r-167) | Ritz-corner state passage, positive-time trace-class cutoff removal and full-oscillator boundary split | R-167 v3.5 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000839. It retains every v3.4 child, constructs a common full-oscillator state carrier by corner UCP pullback with fixed-witness and local-energy-tightness passage, and removes spectral Ritz projections from positive-imaginary-time energy-dressed form perturbations. Four exact fixtures delimit normalized-Schatten, short-time, energy-escape and UCP-intertwining shortcuts. Full-Q3 equilibrium identity, common alpha, beta-infinity selection, phase classification, the broken-sector GNS gap, C6, Sector A and Pre-A remain open |
