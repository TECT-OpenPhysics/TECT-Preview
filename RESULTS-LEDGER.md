...
| [R-167](#r-167) | Registered-corridor full-oscillator coexistence, ground order and first-Duhamel cutoff passage | R-167 v3.7 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000841. It retains every v3.6 child and proves an integrable half-interval trace-ideal majorant for every affine form envelope `B=a h+bI`, making the exact fixed-`N`, positive-`beta` Q3 first-Duhamel spectral-Ritz removal unconditional. Higher insertions, contour entry, common alpha, algebraic ground identification, DFFR/Ritz branch identity, the broken-sector GNS gap, C6, Sector A and Pre-A remain open |
