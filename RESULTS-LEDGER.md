...
| [R-167](#r-167) | Registered-corridor full-oscillator coexistence, ground order, cutoff passage and categorical tangent-KMS carrier | R-167 v3.9 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000843. It retains every v3.8 child and adds a conditional finite-source combined-residual transfer to target algebraic groundness, a conditional clipped-order carrier separator, and one exact failure of automatic target groundness. The exact-Q3 target representation/core, combined residual, spatial common alpha and broken-sector GNS gap remain open |
