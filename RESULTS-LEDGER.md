...
| [R-167](#r-167) | DFFR Hilbert--Schmidt uniformity, fixed-Ritz phase/gap reductions and common-dynamics route split | R-167 v3.4 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000838. It retains every v3.3 child, gives a conditional M-uniform DFFR simultaneous-entry criterion, proves an exact Hilbert--Schmidt multiplicity obstruction to deriving that criterion from operator bounds, and constructs the fixed-Ritz relative-plus-bounded split needed for a conditional Yarotskii phasewise-gap route. Full-oscillator cutoff removal, exact-Q3 common alpha and beta-infinity selection, the broken-sector GNS gap, C6, Sector A and Pre-A remain open |
