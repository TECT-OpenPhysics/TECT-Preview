...
| [R-167](#r-167) | Registered-corridor full-oscillator coexistence, ground order and first-Duhamel cutoff passage | R-167 v3.6 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000840. It retains every v3.5 child, specializes the inherited full-oscillator DLR and ground-order theorems to `g=lambda=chi=hbar=1`, `r=-N^4`, `c=N^-4`, giving coexistence for every `N>=2`, `beta>=9/5`, explicit ground order, source cusp and locally normal time-zero tangent candidates. It also proves a conditional L1-dominated first-Duhamel Ritz passage and one exact short-time obstruction. Common alpha, algebraic ground identification, DFFR/Ritz branch identity, the broken-sector GNS gap, C6, Sector A and Pre-A remain open |
