...
| [R-167](#r-167) | Common-generator zero-temperature transfer, essential-range multiplier, joint cylinder, zero-source and common-dynamics route split | R-167 v3.2 is the current scoped T0 analytic/exact/executed/audited additive result under EXP-000836. It retains every v3.1 child and proves an abstract conditional KMS-to-ground transfer on one common target generator with a fixed bounded odd separator, while an exact collapse fixture shows finite-step norm separation is insufficient without one fixed witness. Exact-Q3 common spatial dynamics, beta-to-infinity phase families, generator convergence, fixed separator, two-phase full-oscillator transfer, broken-sector GNS gap, C6, Sector A and Pre-A remain open |
