...
| Claim | Title | Tier | Lifecycle | Evidence | Hypotheses | Open gates |
|---|---|---|---|---|---|---|
| [B1-RH-ENUM](claims/B1-RH-ENUM/claim.md) | Reading-H selection within enumerated condensate ensembles | T6 | ACTIVE | ANALYTIC, EXECUTED | H-LAYER, H-ADM-COH, SC-SCOPE | G3PB-III |
