...
| [A2-FULL-PRODUCTION-WELLPOSED](claims/A2-FULL-PRODUCTION-WELLPOSED/claim.md) | Full production gradient-flow well-posedness and pinned equilibrium selection | T6 | ACTIVE | ANALYTIC, EXACT, EXECUTED, CONDITIONAL | A2-H3-CANONICAL-PRODUCTION-FUNCTIONAL | — |
