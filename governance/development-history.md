...
project the current claim state, reusable results, failed routes and reasons,
accepted chronology, live tasks, open gates, and per-claim evidence inventory
into one linked roadmap. They are generated by
