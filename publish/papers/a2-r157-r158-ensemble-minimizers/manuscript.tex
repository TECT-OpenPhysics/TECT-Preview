...
\end{equation}
For the spectral calculation below, the sum
$M_{\rm fam}+k_{\rm lock}(\Id-P_0)$ is the explicit internal matrix displayed
in \eqref{eq:M}.
...
\begin{equation}
 ...
 \label{eq:N-map}
\end{equation}
where $C$ is smooth and no derivative above order two occurs.  To fix the
notation used in the evolution equation, let the real gradient of the local
polynomial be
\begin{equation}
