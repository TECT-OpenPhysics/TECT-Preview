...
PACKAGE_FILES = (
    ...
    "cover-letter.md",
    "submission-notes.tex",
    "submission-notes.pdf",
    "verification/submission_package.py",
    "verification/replay_archived_source.py",
    "verification/runs/submission-notes-qa.json",
    "verification/runs/submission-notes-render.json",
