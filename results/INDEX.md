...
|---|---|---|
| [`R-167`](../RESULTS-LEDGER.md#r-167) | Weighted-energy, cubic graph and thermodynamic-Cauchy route split | T0 (scoped finite-volume/fixed-beta analytic theorem and conditional Hamiltonian-identification target; no beta-independent common-alpha promotion). |
